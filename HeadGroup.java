...
class HeadGroup
{
	...
	public static boolean authorValAdd=false;
	...
	static String subsubartDochead= "";
	static String subsubsubartDochead= "";
	static String subsubsubsubartDochead= "";
	String stereoData ="";
	String altTitle= "";
	String altTitleForRbce= "";
	String brvAltTitle="";
	String altTitleForRbceForPt= "";
	...
	public static int count_abs=0;
	public int countRbce=0;
	...
	public boolean forAuthor=false;
	public String forAuthorAdd="";
	boolean jelkey = false;
	public static String contributorRole = "";//Added on 05-09-2018
	public static String dataAvailability = "";//28-08-2012 JADTD520 Updation
	public static String conflictOfInterest = "";//28-08-2012 JADTD520 Updation
	...
	HeadGroup(XMLObjects xmlObj)throws java.io.IOException
	{
		this.xmlObj = xmlObj;
		fin         = xmlObj.fin;
	...
	public String processDisplayFigure(String tage)throws java.io.IOException
	{
		...
		while (!tag.equals("</CE:FIGURE>"))
		{
			...
			if (ch=='<')
			{
				...
				else if (tag.startsWith("<CE:ALT-TEXT "))
				{
					altText=xmlObj.extractData("</CE:ALT-TEXT>", true);//TO BE HANDLED LATER FOR DTD 5.4.0
					//System.out.println("altText found ==========> "+altText);
				}
	...
	for(int i=0;i<figCol.size();i++)
	{
		...
		if (xmlObj.figInfo.containsKey(new String(figLoc)))
		{
			...
			String temp_label=label;//TO BE DEFINED FOR VALUE OF <CE:ALT-TEXT>
			/*String temp_label="";
			if(altText.isEmpty()){
				temp_label=label;
...
//			ThomsonDiff\_ThomsonDiffOpenBrace1ThomsonDiffCloseBrace
			...
			//System.out.println("temp_label ::>"+temp_label);
	...
	public String processEAltComponent(String tage, String figId, String lbl)throws java.io.IOException
	{
		...
		while (!tag.equals("</CE:ALT-E-COMPONENT>"))
		{
			...
			if (ch=='<')
			{
				...
				{
					//figCol.add(tag.substring(tag.indexOf("<CE:LINK LOCATOR=\"")+18, tag.indexOf("\"/>")).toUpperCase());
					String linkLocator= xmlObj.getAttributeValue(tag, "LOCATOR");
					figCol.add(linkLocator);
				}
				else if (tag.startsWith("<CE:COPYRIGHT"))
...
return sd;
	...
	public String processAbstract(String etag)throws java.io.IOException
	{
		...
		*/
		...
		XT modXt=new XT();
		boolean modelDAbstr=modXt.chekJidAid(xmlObj.jid, xmlObj.aid);
...
*/
				...
				if(absClass.equals("GRAPHICAL"))
				{
					...
					// contains a section within the abstract.
								//System.out.println ("abstractGraphical 1===>"+abstractGraphical);
								fstP       = true;
							}
							else if (tag.equals("<CE:SIMPLE-PARA>")  || tag.startsWith("<CE:SIMPLE-PARA"))//04-01-2005
							{
								//System.out.println ("abstractGraphical 2===>"+abstractGraphical);
								if(fstP==false)
								{
									abstractGraphical.append("\r\n\r\n");
							...
							{
								//System.out.println ("abstractGraphical 3===>"+abstractGraphical);
								...
								absSecTitl=absSecTitl.replaceAll("\\\\\\(\\\\backslash\\\\\\)protect\\\\\\(\\\\backslash\\\\\\)qtoa\\\\\\{Q([0-9]+)\\\\\\}","");
								tempabsSecTitl=tempabsSecTitl.replaceAll("\\\\\\(\\\\backslash\\\\\\)protect\\\\\\(\\\\backslash\\\\\\)qtoa\\\\\\{Q([0-9]+)\\\\\\}","\\\\\\\\protect\\\\\\\\qtoa\\{Q$1\\}");
								//System.out.println("absSecTitl==========>"+absSecTitl);
								//System.out.println("tempabsSecTitl======>"+tempabsSecTitl);
								...
								*/
								if(absSecTitl.equalsIgnoreCase("Research highlights")||absSecTitl.equalsIgnoreCase("Research highlight")||absSecTitl.equalsIgnoreCase("highlights")||absSecTitl.equalsIgnoreCase("highlight"))
								{
									checkRHTitle=true;
									if((!xmlObj.jid.equalsIgnoreCase("APCATA")||!xmlObj.jid.equalsIgnoreCase("CPLETT"))){
							...
							{
								//System.out.println ("abstractGraphical 4===>"+abstractGraphical);
								...
								//System.out.println ("abstractGraphical 5===>"+abstractGraphical);
						}
						else
						{
					...
					if((!xmlObj.jid.equalsIgnoreCase("APCATA")||!xmlObj.jid.equalsIgnoreCase("CPLETT")))
					{
						...
						finalgraphabstractcontentRH=finalgraphabstractcontentRH.replaceAll("\r\n\\\\authors\r\n","");
					}
...
if(finalgraphabstractcontent.indexOf("RTOPEN************",0)!=-1)
		{
			...
			if(((XT.modelStyle.toUpperCase().startsWith("-MODDFRENCH"))||(XT.modelStyle.toUpperCase().startsWith("-MODEFRENCH"))) && (xmlObj.pit.equalsIgnoreCase("ABS")||xmlObj.pit.equalsIgnoreCase("BPH")||xmlObj.pit.equalsIgnoreCase("BRV")||xmlObj.pit.equalsIgnoreCase("CAL")||xmlObj.pit.equalsIgnoreCase("CNF")||xmlObj.pit.equalsIgnoreCase("COR")||xmlObj.pit.equalsIgnoreCase("EDI")||xmlObj.pit.equalsIgnoreCase("EXM")||xmlObj.pit.equalsIgnoreCase("IND")||xmlObj.pit.equalsIgnoreCase("LIT")||xmlObj.pit.equalsIgnoreCase("NWS")||xmlObj.pit.equalsIgnoreCase("PRP"))){
...
//		if((xmlObj.jid.equalsIgnoreCase("NEUCLI")||xmlObj.jid.equalsIgnoreCase("ENCEP")||xmlObj.jid.equalsIgnoreCase("SEXOL")||xmlObj.jid.equalsIgnoreCase("RCO")||xmlObj.jid.equalsIgnoreCase("MEDPAL")||xmlObj.jid.equalsIgnoreCase("NEURAD")||xmlObj.jid.equalsIgnoreCase("IMMBIO")||xmlObj.jid.equalsIgnoreCase("MORPHO")||xmlObj.jid.equalsIgnoreCase("JMV")||xmlObj.jid.equalsIgnoreCase("REAURG")||xmlObj.jid.equalsIgnoreCase("JGYN")) &&((absLang.equals("EN") && XT.articleType.equals("FR")) || (absLang.equals("FR") && XT.articleType.equals("EN"))))
		...
		else if(xmlObj.jid.equalsIgnoreCase("RBCE") || xmlObj.jid.equalsIgnoreCase("REU"))
		{
			if(absLang.equalsIgnoreCase("EN"))
			{
				if(count_abs==1)
				{
			...
			if(absLang.equalsIgnoreCase("PT"))
			{
				if(count_abs==1)
				{
					abstractInfo.append("\\begin{abstract}[LANGUAGE=\""+xmlObj.getAbstractLanguage(absLang)+"\"]");
			...
			if(absLang.equalsIgnoreCase("ES"))
			{
				if(count_abs==1)
				{
					abstractInfo.append("\\begin{abstract}[LANGUAGE=\""+xmlObj.getAbstractLanguage(absLang)+"\"]");
				...
				else if (tag.startsWith("<CE:SECTION-TITLE"))
				{
					...
					else
					{
						if(xmlObj.jid.equalsIgnoreCase("JECS"))
							abstractInfo.append("\r\n\\abstractsection{"+absSecTitl+"}\r\n\\noindent ");
						else if(xmlObj.jid.equalsIgnoreCase("HYA") || xmlObj.jid.equalsIgnoreCase("STMAT") || xmlObj.jid.equalsIgnoreCase("CYA") || xmlObj.jid.equalsIgnoreCase("DF") || xmlObj.jid.equalsIgnoreCase("RESU") || xmlObj.jid.equalsIgnoreCase("ANTRO") || xmlObj.jid.equalsIgnoreCase("RMB") || xmlObj.jid.equalsIgnoreCase("REGE") || xmlObj.jid.equalsIgnoreCase("RAUSP") || xmlObj.jid.equalsIgnoreCase("RAUSPM") || xmlObj.jid.equalsIgnoreCase("AIPPRR") || xmlObj.jid.equalsIgnoreCase("BIOET") || xmlObj.jid.equalsIgnoreCase("JART") || xmlObj.jid.equalsIgnoreCase("JBHSI") || xmlObj.jid.equalsIgnoreCase("RAI"))
						{
							if(xmlObj.getAbstractLanguage(absLang).equalsIgnoreCase("SPANISH"))
								abstractInfo.append("\r\n\\sabstractsection{"+absSecTitl+"}\r\n");
							else
								abstractInfo.append("\r\n\\abstractsection{"+absSecTitl+"}\r\n");
						}
						else
...
//System.out.println("XT.modelStyle-----------"+XT.fmcforall);
		...
		if((xmlObj.jid.equalsIgnoreCase("PALEVO") ||xmlObj.jid.equalsIgnoreCase("REVMED")|| (xmlObj.jid.equalsIgnoreCase("ENCEP") && Integer.parseInt(xmlObj.aid)>795) ||xmlObj.jid.equalsIgnoreCase("ECON")||xmlObj.jid.equalsIgnoreCase("SCOMS")||xmlObj.jid.equalsIgnoreCase("MONRHU")||xmlObj.jid.equalsIgnoreCase("PATBIO")||xmlObj.jid.equalsIgnoreCase("BIOPHA")||xmlObj.jid.equalsIgnoreCase("REVRHU")||xmlObj.jid.equalsIgnoreCase("DIABET")||xmlObj.jid.equalsIgnoreCase("ERAP")||xmlObj.jid.equalsIgnoreCase("HYA")||xmlObj.jid.equalsIgnoreCase("STMAT")||xmlObj.jid.equalsIgnoreCase("CYA")||xmlObj.jid.equalsIgnoreCase("DF")||xmlObj.jid.equalsIgnoreCase("RESU")||xmlObj.jid.equalsIgnoreCase("ANTRO")||xmlObj.jid.equalsIgnoreCase("RMB")||xmlObj.jid.equalsIgnoreCase("REGE")||xmlObj.jid.equalsIgnoreCase("RAUSP")||xmlObj.jid.equalsIgnoreCase("RAUSPM")||xmlObj.jid.equalsIgnoreCase("AIPPRR")||xmlObj.jid.equalsIgnoreCase("BIOET")||xmlObj.jid.equalsIgnoreCase("JART")||xmlObj.jid.equalsIgnoreCase("JBHSI")||xmlObj.jid.equalsIgnoreCase("RAI")||xmlObj.jid.equalsIgnoreCase("ANDO")||xmlObj.jid.equalsIgnoreCase("RESPE")||xmlObj.jid.equalsIgnoreCase("REVAL")||xmlObj.jid.equalsIgnoreCase("MEDMAL")||xmlObj.jid.equalsIgnoreCase("NEUCHI")||xmlObj.jid.equalsIgnoreCase("MEDDRO")||xmlObj.jid.equalsIgnoreCase("CANRAD")||xmlObj.jid.equalsIgnoreCase("OFTAL")||XT.modelStyle.startsWith("7Spanish")||xmlObj.jid.equalsIgnoreCase("RBMRET")||xmlObj.jid.equalsIgnoreCase("IRBM")||(xmlObj.jid.equalsIgnoreCase("SCISPO")&&(Integer.parseInt(XT.plusTable.get(xmlObj.jid).toString())>Integer.parseInt(intaid(xmlObj.aid))))||xmlObj.jid.equalsIgnoreCase("NUTCLI")||xmlObj.jid.equalsIgnoreCase("ANCAAN")||xmlObj.jid.equalsIgnoreCase("CHIMAI")|| xmlObj.jid.equalsIgnoreCase("ANNPAL")|| xmlObj.jid.equalsIgnoreCase("EURPSY")|| xmlObj.jid.equalsIgnoreCase("ALTER")|| xmlObj.jid.equalsIgnoreCase("EXMATH")|| xmlObj.jid.equalsIgnoreCase("DDES")|| xmlObj.jid.equalsIgnoreCase("SMED")|| xmlObj.jid.equalsIgnoreCase("PSFR")|| xmlObj.jid.equalsIgnoreCase("EHN")|| xmlObj.jid.equalsIgnoreCase("EHMCM")|| xmlObj.jid.equalsIgnoreCase("PRPS")|| xmlObj.jid.equalsIgnoreCase("SOCTRA") || xmlObj.jid.equalsIgnoreCase("EVOPSY") || xmlObj.jid.equalsIgnoreCase("REVMIC") || xmlObj.jid.equalsIgnoreCase("ACCPM") || xmlObj.jid.equalsIgnoreCase("DIABET") || xmlObj.jid.equalsIgnoreCase("EJTD") || xmlObj.jid.equalsIgnoreCase("EURGER") || xmlObj.jid.equalsIgnoreCase("EURPSY") || xmlObj.jid.equalsIgnoreCase("GEOBIO") || xmlObj.jid.equalsIgnoreCase("GOFS") || xmlObj.jid.equalsIgnoreCase("HANSUR") || xmlObj.jid.equalsIgnoreCase("INAN") || xmlObj.jid.equalsIgnoreCase("JOGOH") || xmlObj.jid.equalsIgnoreCase("JORMAS") || xmlObj.jid.equalsIgnoreCase("MEDNUC") || xmlObj.jid.equalsIgnoreCase("MYCMED") || xmlObj.jid.equalsIgnoreCase("RETRAM") || xmlObj.jid.equalsIgnoreCase("ARCPED") || xmlObj.jid.equalsIgnoreCase("BONSOI")||(xmlObj.jid.equalsIgnoreCase("BIONUT"))||(xmlObj.jid.equalsIgnoreCase("BIOMAG"))|| xmlObj.jid.equalsIgnoreCase("CULHER")|| xmlObj.jid.equalsIgnoreCase("MLA")))
		{
			...
			if(XT.IsCutOffCR.containsKey(xmlObj.jid.toString()))//mukesh on 01-11-08 TPMS
			{
				...
				String thisaid=xmlObj.aid;
				if(thisaid.indexOf(".",0)!=-1)
				{
					thisaid=thisaid.substring(0,thisaid.indexOf(".",0));
				}

				if(Integer.parseInt(thisaid) >=(Integer.parseInt(tempAid)))
				{
					//System.out.println("2-----------"+st12);
					//System.out.println("AbstractLanguage-->"+xmlObj.getAbstractLanguage(absLang));
					if(xmlObj.getAbstractLanguage(absLang).equalsIgnoreCase("FRENCH"))
					{
						abstractInfo.append("\r\n\\FRcopyright\r\n\\end{abstract}");
		...
		else if((xmlObj.jid.equalsIgnoreCase("PALEVO") ||xmlObj.jid.equalsIgnoreCase("REVMED")|| (xmlObj.jid.equalsIgnoreCase("ENCEP") && Integer.parseInt(xmlObj.aid)>795) ||xmlObj.jid.equalsIgnoreCase("ECON")||xmlObj.jid.equalsIgnoreCase("SCOMS") ||xmlObj.jid.equalsIgnoreCase("MONRHU")||xmlObj.jid.equalsIgnoreCase("PATBIO")||xmlObj.jid.equalsIgnoreCase("BIOPHA")||xmlObj.jid.equalsIgnoreCase("REVRHU")||xmlObj.jid.equalsIgnoreCase("DIABET")||xmlObj.jid.equalsIgnoreCase("ERAP")||xmlObj.jid.equalsIgnoreCase("HYA")||xmlObj.jid.equalsIgnoreCase("STMAT")||xmlObj.jid.equalsIgnoreCase("CYA")||xmlObj.jid.equalsIgnoreCase("DF")||xmlObj.jid.equalsIgnoreCase("RESU")||xmlObj.jid.equalsIgnoreCase("ANTRO")||xmlObj.jid.equalsIgnoreCase("RMB")||xmlObj.jid.equalsIgnoreCase("REGE")||xmlObj.jid.equalsIgnoreCase("RAUSP")||xmlObj.jid.equalsIgnoreCase("RAUSPM")||xmlObj.jid.equalsIgnoreCase("AIPPRR")||xmlObj.jid.equalsIgnoreCase("BIOET")||xmlObj.jid.equalsIgnoreCase("JART")||xmlObj.jid.equalsIgnoreCase("JBHSI")||xmlObj.jid.equalsIgnoreCase("RAI")||xmlObj.jid.equalsIgnoreCase("ANDO")||xmlObj.jid.equalsIgnoreCase("REVAL")||xmlObj.jid.equalsIgnoreCase("MEDMAL")||xmlObj.jid.equalsIgnoreCase("NEUCHI")||(xmlObj.jid.equalsIgnoreCase("NEUADO") && XT.fmcforall==false)||xmlObj.jid.equalsIgnoreCase("MEDDRO")||xmlObj.jid.equalsIgnoreCase("CANRAD")||xmlObj.jid.equalsIgnoreCase("RBMRET")||xmlObj.jid.equalsIgnoreCase("IRBM")||(xmlObj.jid.equalsIgnoreCase("SCISPO")&&(Integer.parseInt(XT.plusTable.get(xmlObj.jid).toString())>Integer.parseInt(intaid(xmlObj.aid))))||xmlObj.jid.equalsIgnoreCase("NUTCLI")||xmlObj.jid.equalsIgnoreCase("ANCAAN")||xmlObj.jid.equalsIgnoreCase("CHIMAI") ||(xmlObj.jid.equalsIgnoreCase("JTS")&&(XT.fmcforall==false))||(( xmlObj.jid.equalsIgnoreCase("TRACLI"))&&(XT.fmcforall==false)) || xmlObj.jid.equalsIgnoreCase("ANNPAL") || xmlObj.jid.equalsIgnoreCase("EURPSY")|| xmlObj.jid.equalsIgnoreCase("ALTER")|| xmlObj.jid.equalsIgnoreCase("EXMATH")|| xmlObj.jid.equalsIgnoreCase("DDES")|| xmlObj.jid.equalsIgnoreCase("SMED") || xmlObj.jid.equalsIgnoreCase("PSFR") || xmlObj.jid.equalsIgnoreCase("EHN") || xmlObj.jid.equalsIgnoreCase("EHMCM")|| xmlObj.jid.equalsIgnoreCase("PRPS")|| xmlObj.jid.equalsIgnoreCase("SOCTRA")|| xmlObj.jid.equalsIgnoreCase("EVOPSY") || xmlObj.jid.equalsIgnoreCase("REVMIC") || xmlObj.jid.equalsIgnoreCase("ACCPM") || xmlObj.jid.equalsIgnoreCase("DIABET") || xmlObj.jid.equalsIgnoreCase("EJTD") || xmlObj.jid.equalsIgnoreCase("EURGER") || xmlObj.jid.equalsIgnoreCase("EURPSY") || xmlObj.jid.equalsIgnoreCase("GEOBIO") || xmlObj.jid.equalsIgnoreCase("GOFS") || xmlObj.jid.equalsIgnoreCase("HANSUR") || xmlObj.jid.equalsIgnoreCase("INAN") || xmlObj.jid.equalsIgnoreCase("JOGOH") || xmlObj.jid.equalsIgnoreCase("JORMAS") || xmlObj.jid.equalsIgnoreCase("MEDNUC") || xmlObj.jid.equalsIgnoreCase("MYCMED") || xmlObj.jid.equalsIgnoreCase("RETRAM") || xmlObj.jid.equalsIgnoreCase("ARCPED") || xmlObj.jid.equalsIgnoreCase("BONSOI")||(xmlObj.jid.equalsIgnoreCase("BIONUT"))||(xmlObj.jid.equalsIgnoreCase("BIOMAG"))|| xmlObj.jid.equalsIgnoreCase("CULHER")) && absLang.equals("EN") && XT.articleType.equals("EN"))
		{
			//abstractInfo.append("\r\n\\Frenchcopyright\r\n%\\end{abstract}");
			//System.out.println("22-----------Ravi ");
			if(XT.IsCutOffCR.containsKey(xmlObj.jid.toString()))//mukesh on 01-11-08 TPMS
...
//		else if((xmlObj.jid.equalsIgnoreCase("NEUCLI")|| xmlObj.jid.equalsIgnoreCase("ENCEP") || xmlObj.jid.equalsIgnoreCase("SEXOL")||xmlObj.jid.equalsIgnoreCase("RCO")||xmlObj.jid.equalsIgnoreCase("MEDPAL")||xmlObj.jid.equalsIgnoreCase("NEURAD")||xmlObj.jid.equalsIgnoreCase("IMMBIO")||xmlObj.jid.equalsIgnoreCase("MORPHO")||xmlObj.jid.equalsIgnoreCase("JMV")|| xmlObj.jid.equalsIgnoreCase("REAURG") || xmlObj.jid.equalsIgnoreCase("JGYN")) && ((absLang.equals("EN") && XT.articleType.equals("FR")) || (absLang.equals("FR") && XT.articleType.equals("EN"))))
		else if((xmlObj.jid.equalsIgnoreCase("NEUCLI")||xmlObj.jid.equalsIgnoreCase("QUIP")|| (xmlObj.jid.equalsIgnoreCase("ENCEP") && Integer.parseInt(xmlObj.aid)<796)|| xmlObj.jid.equalsIgnoreCase("SCOMS") || xmlObj.jid.equalsIgnoreCase("SEXOL")||xmlObj.jid.equalsIgnoreCase("OTSR")||xmlObj.jid.equalsIgnoreCase("JOCLIM")||xmlObj.jid.equalsIgnoreCase("SODA")||xmlObj.jid.equalsIgnoreCase("LIVER")||xmlObj.jid.equalsIgnoreCase("DEMAN")||xmlObj.jid.equalsIgnoreCase("STLM")||xmlObj.jid.equalsIgnoreCase("ANNDER")||xmlObj.jid.equalsIgnoreCase("RCOT")||xmlObj.jid.equalsIgnoreCase("RCO")||xmlObj.jid.equalsIgnoreCase("JVS")||xmlObj.jid.equalsIgnoreCase("JCHIRV")||xmlObj.jid.equalsIgnoreCase("JCHIR")||xmlObj.jid.equalsIgnoreCase("ANNPAT")||xmlObj.jid.equalsIgnoreCase("FEMME")||xmlObj.jid.equalsIgnoreCase("CND")||xmlObj.jid.equalsIgnoreCase("MEDPAL")||xmlObj.jid.equalsIgnoreCase("EURTEL")||xmlObj.jid.equalsIgnoreCase("REVHOM")||xmlObj.jid.equalsIgnoreCase("JCCO")||xmlObj.jid.equalsIgnoreCase("JEUREA")||xmlObj.jid.equalsIgnoreCase("NEURAD")||xmlObj.jid.equalsIgnoreCase("IMMBIO")||xmlObj.jid.equalsIgnoreCase("MORPHO")||xmlObj.jid.equalsIgnoreCase("JMV")||xmlObj.jid.equalsIgnoreCase("JDMV")||xmlObj.jid.equalsIgnoreCase("BANM")|| xmlObj.jid.equalsIgnoreCase("REAURG")||xmlObj.jid.equalsIgnoreCase("JFO")||xmlObj.jid.equalsIgnoreCase("MLONG")||xmlObj.jid.equalsIgnoreCase("LONGEV")||xmlObj.jid.equalsIgnoreCase("RMR")||xmlObj.jid.equalsIgnoreCase("PEDPUE")||xmlObj.jid.equalsIgnoreCase("ANNDEROLD")||xmlObj.jid.equalsIgnoreCase("FANDER")||xmlObj.jid.equalsIgnoreCase("ACVDSP")||xmlObj.jid.equalsIgnoreCase("JEMEP")||xmlObj.jid.equalsIgnoreCase("REFIRI")||xmlObj.jid.equalsIgnoreCase("TOXAC")||xmlObj.jid.equalsIgnoreCase("ONCOHP")||xmlObj.jid.equalsIgnoreCase("JRADIO")||xmlObj.jid.equalsIgnoreCase("JRDIA")||xmlObj.jid.equalsIgnoreCase("DIII")||(xmlObj.jid.equalsIgnoreCase("TRACLI")&&(XT.fmcforall==true))||xmlObj.jid.equalsIgnoreCase("MSOM")||xmlObj.jid.equalsIgnoreCase("GCB")||(xmlObj.jid.equalsIgnoreCase("CLINRE"))||(xmlObj.jid.equalsIgnoreCase("CLIREX"))||(xmlObj.jid.equalsIgnoreCase("NEUADO")&&(XT.fmcforall==true))||xmlObj.jid.equalsIgnoreCase("PRATAN")||xmlObj.jid.equalsIgnoreCase("ANICOM")||xmlObj.jid.equalsIgnoreCase("VETCLI")||xmlObj.jid.equalsIgnoreCase("NRL")||xmlObj.jid.equals("NRLENG")||xmlObj.jid.equalsIgnoreCase("APRIM")||xmlObj.jid.equalsIgnoreCase("EJPSY")||xmlObj.jid.equalsIgnoreCase("REPOD")||xmlObj.jid.equalsIgnoreCase("RPTOB")||xmlObj.jid.equalsIgnoreCase("RAA")||xmlObj.jid.equalsIgnoreCase("RCHIC")||xmlObj.jid.equalsIgnoreCase("RCHIRA")||xmlObj.jid.equalsIgnoreCase("RPRH")||xmlObj.jid.equalsIgnoreCase("RCHOT")||xmlObj.jid.equalsIgnoreCase("RIEM")||xmlObj.jid.equalsIgnoreCase("CC")||xmlObj.jid.equalsIgnoreCase("EDUMED")||xmlObj.jid.equalsIgnoreCase("CIRGEN")||xmlObj.jid.equalsIgnoreCase("MAGIS")||xmlObj.jid.equalsIgnoreCase("EJFB")||xmlObj.jid.equalsIgnoreCase("EJEPS")||xmlObj.jid.equalsIgnoreCase("ANPSIC")||xmlObj.jid.equalsIgnoreCase("MINCOM")||xmlObj.jid.equalsIgnoreCase("RCHIPE")||xmlObj.jid.equalsIgnoreCase("RCCOT")||xmlObj.jid.equalsIgnoreCase("UROCO")||xmlObj.jid.equalsIgnoreCase("SD")||xmlObj.jid.equalsIgnoreCase("SDCAT")||xmlObj.jid.equalsIgnoreCase("SDENG")||xmlObj.jid.equalsIgnoreCase("CIRCIR")||xmlObj.jid.equalsIgnoreCase("CIRCEN")||xmlObj.jid.equalsIgnoreCase("EII")||xmlObj.jid.equalsIgnoreCase("RIPS")||xmlObj.jid.equalsIgnoreCase("ACCI")||xmlObj.jid.equalsIgnoreCase("MEI")||xmlObj.jid.equalsIgnoreCase("MEDRE")||xmlObj.jid.equalsIgnoreCase("REU")||xmlObj.jid.equalsIgnoreCase("UROMX")||xmlObj.jid.equalsIgnoreCase("ANCV")||xmlObj.jid.equalsIgnoreCase("ACUP")||xmlObj.jid.equalsIgnoreCase("HGMX")||xmlObj.jid.equalsIgnoreCase("BMHIMX")||xmlObj.jid.equalsIgnoreCase("RARD")||xmlObj.jid.equalsIgnoreCase("RCCAR")||xmlObj.jid.equalsIgnoreCase("PIRO")||xmlObj.jid.equalsIgnoreCase("REIMKE")||xmlObj.jid.equalsIgnoreCase("SJME")||xmlObj.jid.equalsIgnoreCase("EQ")||xmlObj.jid.equalsIgnoreCase("RLP")||xmlObj.jid.equalsIgnoreCase("RMTA")||xmlObj.jid.equalsIgnoreCase("RCCAN")||xmlObj.jid.equalsIgnoreCase("BJORL")||xmlObj.jid.equalsIgnoreCase("BJORLP")||xmlObj.jid.equalsIgnoreCase("ENDMAG")||xmlObj.jid.equalsIgnoreCase("IJCHP")||xmlObj.jid.equalsIgnoreCase("MEXOFT")||xmlObj.jid.equalsIgnoreCase("RAM")||xmlObj.jid.equalsIgnoreCase("BJAN")||xmlObj.jid.equalsIgnoreCase("BJANE")||xmlObj.jid.equalsIgnoreCase("BJANES")||xmlObj.jid.equalsIgnoreCase("CESJEF")||xmlObj.jid.equalsIgnoreCase("SEDENE")||xmlObj.jid.equalsIgnoreCase("SEDENG")||xmlObj.jid.equalsIgnoreCase("RGMX")||xmlObj.jid.equalsIgnoreCase("RLFA")||xmlObj.jid.equalsIgnoreCase("CESJEF")||xmlObj.jid.equals("ANGIO")||xmlObj.jid.equals("RIFK")||xmlObj.jid.equals("REDAR")||xmlObj.jid.equals("REDARE")||xmlObj.jid.equals("REMLE")||xmlObj.jid.equalsIgnoreCase("DIALIS")||xmlObj.jid.equals("RPSM")||xmlObj.jid.equals("AVDIAB")||xmlObj.jid.equals("MEDIPA")||xmlObj.jid.equals("IMADI")||xmlObj.jid.equals("ANDROL")||xmlObj.jid.equals("ACMX")||xmlObj.jid.equals("INFECT")||xmlObj.jid.equals("REML")||xmlObj.jid.equals("PATOL")||xmlObj.jid.equals("FT")||xmlObj.jid.equals("RECOT")||xmlObj.jid.equals("SEMERG")||xmlObj.jid.equals("CALI")||xmlObj.jid.equals("JHQR")||xmlObj.jid.equals("ENDONU")||xmlObj.jid.equals("ENDINU")||xmlObj.jid.equals("SENOL")||xmlObj.jid.equals("REUMA")||xmlObj.jid.equals("REUMAE")||xmlObj.jid.equals("PSIQ")||xmlObj.jid.equals("REMN")||xmlObj.jid.equals("REMNIM")||xmlObj.jid.equals("REMNGL")||xmlObj.jid.equals("REMNIE")||xmlObj.jid.equals("REGG")||xmlObj.jid.equals("PBJ")||xmlObj.jid.equals("RIBA")||xmlObj.jid.equals("APPR")||xmlObj.jid.equals("MEDCLI")||xmlObj.jid.equals("MEDCLE")||xmlObj.jid.equals("APJ")||xmlObj.jid.equals("PSE")||xmlObj.jid.equals("CLYSA")||xmlObj.jid.equals("CLYSA")||xmlObj.jid.equals("RPTO")||xmlObj.jid.equals("GEMREV")||xmlObj.jid.equals("ESPE")||xmlObj.jid.equals("AULA")||xmlObj.jid.equals("EJPAL")||xmlObj.jid.equals("BJP")||xmlObj.jid.equals("RBE")||xmlObj.jid.equals("JEFAS")||xmlObj.jid.equals("ESTGER")||xmlObj.jid.equals("RAMD")||xmlObj.jid.equals("RCSAR")||xmlObj.jid.equals("PSI")||xmlObj.jid.equals("ANYES")||xmlObj.jid.equals("JIK")||xmlObj.jid.equals("CIRCV")||xmlObj.jid.equals("RPEDM")||xmlObj.jid.equals("CEDE")||xmlObj.jid.equals("BRQ")||xmlObj.jid.equals("RIMNI")||xmlObj.jid.equals("SRFE")||xmlObj.jid.equals("IHE")||xmlObj.jid.equals("REDEE")||xmlObj.jid.equals("REDEEN")||xmlObj.jid.equals("IEDEE")||xmlObj.jid.equals("IEDEEN")||xmlObj.jid.equals("SEMREU")||xmlObj.jid.equals("MCP")||xmlObj.jid.equals("RIAM")||xmlObj.jid.equals("EIMC")||xmlObj.jid.equals("PSICOD")||xmlObj.jid.equals("EIMCE")||xmlObj.jid.equals("PSICOE")||xmlObj.jid.equals("GACETA")||xmlObj.jid.equals("ARBRES")||xmlObj.jid.equals("OPRESP")||xmlObj.jid.equals("ARBR")||xmlObj.jid.equalsIgnoreCase("ABD")||xmlObj.jid.equalsIgnoreCase("ABDP")||xmlObj.jid.equalsIgnoreCase("JPED")||xmlObj.jid.equalsIgnoreCase("RPPED")||xmlObj.jid.equalsIgnoreCase("AD")||xmlObj.jid.equalsIgnoreCase("JPEDP")||xmlObj.jid.equalsIgnoreCase("ADENGL")||xmlObj.jid.equalsIgnoreCase("ACURO")||xmlObj.jid.equalsIgnoreCase("ACUROE")||xmlObj.jid.equalsIgnoreCase("RICMA")||xmlObj.jid.equalsIgnoreCase("RPPEDE")||xmlObj.jid.equals("ANPEDI")||xmlObj.jid.equals("ANPEDE")||xmlObj.jid.equals("RCE")||xmlObj.jid.equals("RCENG")||xmlObj.jid.equalsIgnoreCase("FARMA")||xmlObj.jid.equalsIgnoreCase("FARMAE")||xmlObj.jid.equalsIgnoreCase("RXENG")||xmlObj.jid.equalsIgnoreCase("REPC")||xmlObj.jid.equals("JPG")||xmlObj.jid.equals("JPGE")||xmlObj.jid.equalsIgnoreCase("REPCE")||xmlObj.jid.equalsIgnoreCase("RECOTE")||xmlObj.jid.equalsIgnoreCase("RPSMEN")||xmlObj.jid.equalsIgnoreCase("ENDOEN")||xmlObj.jid.equalsIgnoreCase("ENDIEN")||xmlObj.jid.equalsIgnoreCase("OTOENG")||xmlObj.jid.equalsIgnoreCase("MEDINE")||xmlObj.jid.equalsIgnoreCase("BMHIME")||xmlObj.jid.equalsIgnoreCase("RGMXEN")||xmlObj.jid.equalsIgnoreCase("RX")||xmlObj.jid.equalsIgnoreCase("RCE")||xmlObj.jid.equalsIgnoreCase("TEKHNE")||xmlObj.jid.equalsIgnoreCase("ALLER")||xmlObj.jid.equalsIgnoreCase("GAMO")||xmlObj.jid.equalsIgnoreCase("RMU")||xmlObj.jid.equalsIgnoreCase("OPTOM")||xmlObj.jid.equalsIgnoreCase("BJPT")||xmlObj.jid.equals("OTORRI")||xmlObj.jid.equals("GASTRO")||xmlObj.jid.equals("GASTRE")||xmlObj.jid.equalsIgnoreCase("GINE")||xmlObj.jid.equals("APUNTS")||xmlObj.jid.equals("RPPNEU")||xmlObj.jid.equals("PULMOE")||xmlObj.jid.equals("LABCLI")||xmlObj.jid.equals("HIPERT")||xmlObj.jid.equals("ARTERI")||xmlObj.jid.equals("ARTERE")||xmlObj.jid.equals("RH")||xmlObj.jid.equals("ENFI")||xmlObj.jid.equals("ENFIE")||xmlObj.jid.equals("ENFCLI")||xmlObj.jid.equals("ENFCLE")||xmlObj.jid.equalsIgnoreCase("MEDIN")||xmlObj.jid.equalsIgnoreCase("ENDOMX") || xmlObj.jid.equalsIgnoreCase("JGYN")||xmlObj.jid.equalsIgnoreCase("AFJU")||xmlObj.jid.equalsIgnoreCase("AFORL")||xmlObj.jid.equalsIgnoreCase("ANORL")||xmlObj.jid.equalsIgnoreCase("JTCC")||xmlObj.jid.equalsIgnoreCase("JBCT")||xmlObj.jid.equalsIgnoreCase("ETIQE")||xmlObj.jid.equalsIgnoreCase("PUROL")||xmlObj.jid.equalsIgnoreCase("NPG")||xmlObj.jid.equalsIgnoreCase("PHARMA")||xmlObj.jid.equalsIgnoreCase("SAGF")||xmlObj.jid.equalsIgnoreCase("PNEUMO")||xmlObj.jid.equalsIgnoreCase("DOULER")||xmlObj.jid.equalsIgnoreCase("ACVD") ||xmlObj.jid.equalsIgnoreCase("JFO")||xmlObj.jid.equalsIgnoreCase("ANNDEROLD")||xmlObj.jid.equalsIgnoreCase("FANDER")||xmlObj.jid.equalsIgnoreCase("THERAP")||xmlObj.jid.equalsIgnoreCase("MSOM")||(xmlObj.jid.equalsIgnoreCase("JTS")&&(XT.fmcforall==true))||(xmlObj.jid.equalsIgnoreCase("SCISPO")&&(Integer.parseInt(XT.plusTable.get(xmlObj.jid).toString())<=Integer.parseInt(intaid(xmlObj.aid))))))
		{	
			...
			if(XT.IsCutOffCR.containsKey(xmlObj.jid.toString()))//mukesh on 01-11-08 TPMS
			{
				String tempAid="";
				tempAid=XT.IsCutOffCR.get(xmlObj.jid.toString()).toString();
				String artaid=xmlObj.aid;
				if(artaid.indexOf(".",0)!=-1)
				{
					artaid=artaid.substring(0,artaid.indexOf(".",0));
				}
				if(Integer.parseInt(artaid) >=(Integer.parseInt(tempAid)))
				{
					if(xmlObj.getAbstractLanguage(absLang).equalsIgnoreCase("FRENCH"))
					{abstractInfo.append("\r\n\\FRcopyright"+st12+"\r\n\\end{abstract"+st12+"}\r\n");}
					else if(xmlObj.getAbstractLanguage(absLang).equalsIgnoreCase("ITALIAN"))
...
public String getHistoryDate(String dtTag)throws java.io.IOException
	{
		...
		*/
		...
		{
			//Updated on 16-05-2016 to replace hard code " de " to monthPrefix to change the valued d' for month 4, 8 and 10.
			String monthPrefix=" de ";
			if(mon.equals("4") || mon.equals("8") || mon.equals("10"))
				monthPrefix=" d'";
//			String temp=("\\"+dtType+"{"+day+" de "+CAmonths[Integer.parseInt(mon)-1]+" de "+yr+"}");
			String temp=("\\"+dtType+"{"+day+ monthPrefix +CAmonths[Integer.parseInt(mon)-1]+" de "+yr+"}");
			
			if(day.length()>0){
//					return ("\\"+dtType+"{"+day+" de "+CAmonths[Integer.parseInt(mon)-1]+" de "+yr+"}");
					return ("\\"+dtType+"{"+day+ monthPrefix  +CAmonths[Integer.parseInt(mon)-1]+" de "+yr+"}");
			}else{
//				return ("\\"+dtType+"{ de "+CAmonths[Integer.parseInt(mon)-1]+" de "+yr+"}");
				return ("\\"+dtType+"{"+ monthPrefix +CAmonths[Integer.parseInt(mon)-1]+" de "+yr+"}");
			}
		}
		...
		while (!tag.equals("</CE:ARTICLE-FOOTNOTE>"))
		{
			...
			if (ch=='<')
			{
				...
				//	tempCountTitle=tempCountTitle.replaceAll("\\\\\\(\\[A-Za-z]+\\\\\\)","$1");
					...
					tempCountTitle=tempCountTitle.replaceAll("\\\\\\)","");
					boolean checkAltEntity=xt.chekJidAid(xmlObj.jid,xmlObj.aid);
					...
					{						
						if(checkAltEntity==true && tempCountTitle.startsWith("\\ensuremath{\\lozenge}"))
						{
							if(AltTitleEntity=="")
							{
								AltTitleEntity="{"+tempCountTitle+"}";
							}
							else
							{
								AltTitleEntity+=", {"+tempCountTitle+"}";
...
//*********************************************************************
	...
	public String getHeadContents()throws java.io.IOException
	{
		...
		XT modXt=new XT();
		boolean modelDHeadContent=modXt.chekJidAid(xmlObj.jid, xmlObj.aid);
		
		XT dsf=new XT();
		boolean forPalwol=dsf.forpalworVal;
		//boolean forPalwol=dsf.getTagValueForPalwor(xt.xmlFile,"ce:author-group");
		
		//boolean forPalwor = modXt.getTagValueForPalwor(xt.xmlFile,"ce:author-group");
		//System.out.println("forPalwor : "+forPalwor);
				...
				*/
				...
				else if (tag.startsWith("<CE:ALT-TITLE "))
				{
					...
					if((XT.articleType.equalsIgnoreCase("FR") && absLangGlobal.equalsIgnoreCase("EN")) || (XT.articleType.equalsIgnoreCase("EN") && absLangGlobal.equalsIgnoreCase("FR")))
					{
						...
						String tempTag=tag;
						int absCount=0;
						while (!tempTag.equals("</HEAD>") && !tempTag.equals("</SIMPLE-HEAD>") && !tempTag.equals("</BOOK-REVIEW-HEAD>") && !tempTag.equals("</EXAM>"))
						{
							...
							if(tempTag.startsWith("<CE:ABSTRACT "))
							{
								absCount++;
							}
							if(tempTag.equals("</ARTICLE>") || tempTag.equals("</SIMPLE-ARTICLE>") || tempTag.equals("</BOOK-REVIEW>") || tempTag.equals("</EXAM>"))
								break;
						}
						fin.seek(filePointer);

						coutAltTitle++;
						System.out.println("Processing ALT-TITLE..................................."+coutAltTitle+" and Abstract count:"+absCount);
						
						if(coutAltTitle==2)
						{	
							if((xmlObj.jid.equals("RBCE") || xmlObj.jid.equals("REU")) && absCount>2)
							{
								//altTitleForRbceForPt = "\r\n\\AlttitleTwo{" +altTitleTemp ;
								altTitleForRbceForPt = altTitleTemp ;
								altTitleTemp="";
								//artAbs.append(altTitle +"}\r\n");	
							}
							else
							{
							altTitle += "}\r\n\\AlttitleTwo{" +altTitleTemp ;
						...
						{
							if((xmlObj.jid.equals("RBCE") || xmlObj.jid.equals("REU"))  && absCount>1)
							{
								altTitleForRbce = altTitleTemp ;
								altTitleTemp="";
								//artAbs.append(altTitle +"}\r\n");								
							}
							else
							{
								if(xmlObj.pit.equalsIgnoreCase("brv") && modelDHeadContent)
								{
						...
						if(!AltTitleEntity.equals(""))
						{							
								altTitle+=" \\(^{"+AltTitleEntity+"}\\)";
								AltTitleEntity="";
						}
						//altTitle = "\r\n\\Alttitle{" + xmlObj.extractData("</CE:ALT-TITLE>", true) ;
				...
				else if (tag.equals("<CE:ABSTRACT>") || tag.startsWith("<CE:ABSTRACT "))
				{
					...
					else
					{
						...
						//++count_abs;//Commented on 21-03-2015
						//added on 21-03-2015
						//Counter increased only for normal abstract instead of all
						if(tag.indexOf("CLASS=\"GRAPHICAL\"")==-1 && tag.indexOf("CLASS=\"AUTHOR-HIGHLIGHTS\"")==-1){
							++count_abs;
						}
						
							//System.out.println("TAG VALUE IS:"+tag+" and count_abs is:"+count_abs);
							...
							{								
								artAbs.append(processAbstract(tag));
								countRbce++;
								System.out.println("countRbce===>"+countRbce);
								if((xmlObj.jid.equals("RBCE") || xmlObj.jid.equals("REU")) && absLangGlobal.equalsIgnoreCase("EN") )
								{
									if(countRbce==1 && !altTitleForRbce.equals(""))
									{
										artAbs.append("\r\n\\Alttitleone{"+altTitleForRbce +"}\r\n");
									}
									if(countRbce==2 && !altTitleForRbceForPt.equals(""))
									{
										artAbs.append("\r\n\\AlttitleTwo{"+altTitleForRbceForPt +"}\r\n");
									}
								}
								if((xmlObj.jid.equals("RBCE") || xmlObj.jid.equals("REU")) && absLangGlobal.equalsIgnoreCase("PT"))
								{
									if(countRbce==1 && !altTitleForRbce.equals(""))
									{
										artAbs.append("\r\n\\Alttitleone{"+altTitleForRbce +"}\r\n");
								...
								if((xmlObj.jid.equals("RBCE") || xmlObj.jid.equals("REU")) && absLangGlobal.equalsIgnoreCase("ES"))
								{
									if(countRbce==1 && !altTitleForRbce.equals(""))
									{
										artAbs.append("\r\n\\Alttitleone{"+altTitleForRbce +"}\r\n");
...
//								artAbs.insert(abs_pos,"%");
								int abs_pos=artAbs.lastIndexOf("\\end{abstract}\\begin{abstract");//Chnaged indexOf to lastIndexOf on 21-6-2016
								artAbs.insert(abs_pos,"%");
							}
							//end
					}
...
//							System.out.println("processKeywords(1)");
						...
						else if((!xmlObj.jid.equals("YDLD")) && (!XT.modelStyle.equals("7")||!XT.modelStyle.equals("-PIO")|| !XT.modelStyle.equals("-Mod7IChemE")))//Ravi 01/11/2006
						{
							...
							tempClass=processKeywords(tag);
//							System.out.println("processKeywords(2)");
							//System.out.println("tempClass  -- >  "+tempClass);
							//System.in.read();
							tempClass=tempClass.replaceAll("\\\\sep",";");
							if(tempClass.endsWith("."))
						...
						*/
						//Added By Ravi 01/11/2006
							TempCorAbb="\r\n\\Abbreviation{\r\n";
							tempClass=processKeywords(tag);
//							System.out.println("processKeywords(3)");
							tempClass=tempClass.replaceAll("\\\\sep",";");
							if(tempClass.endsWith("."))
							{
								TempCorAbb+=tempClass+"}";
						...
						else
						{
							xmlObj.abrKwd.append("\r\n\\ABBR{");
							tempClass=processKeywords(tag);
//							System.out.println("processKeywords(4)");
							tempClass=tempClass.replaceAll("\\\\sep",";");
							xmlObj.abrKwd.append(tempClass+"}");
							//System.out.println("tempClass  -- >  "+tempClass);
							//System.in.read();
...
//						artKwd.append(processKeywords(tag));//old blocked.
						if(cutOffaid.trim().length()>0 && XT.fmcforall==false){
							...
							{
								//System.out.println("1");
								if(xmlObj.jid.equalsIgnoreCase("SCISPO")&&(Integer.parseInt(XT.plusTable.get(xmlObj.jid).toString())<=Integer.parseInt(intaid(xmlObj.aid))))//System.out.println("2");
								{
									artKwd.append(processKeywords(tag));
//									System.out.println("processKeywords(5)");
								}else
								{
								int ind=0;
								if ((ind= tag.indexOf("XML:LANG=\""))>0)
...
//										System.out.println("processKeywords(6)");
										//System.out.println("222222222222222222222222 artKwdFranch "+artKwdFranch);
									}
//								else if(localLang.equalsIgnoreCase("PT"))//Updated on 10/05/2016
								else if(localLang.equalsIgnoreCase("PT") && (!xmlObj.jid.equals("ECON")))//Updated on 18/06/2016 to ignore jid ECON
								{
									artKwdFranch.append(processKeywords(tag));
//									System.out.println("processKeywords(7)");
									//System.out.println("222222222222222222222222 artKwdFranch "+artKwdFranch);
								}
								else if(localLang.equalsIgnoreCase("IT"))
								{
									//System.out.println("2 localLang "+localLang);
									artKwd.append(processKeywords(tag));
//									System.out.println("processKeywords(8)");
									//System.out.println("222222222222222222222222 artKwd "+artKwd);

								}
								else if(localLang.equalsIgnoreCase("ES") && (xmlObj.jid.equals("HYA") || xmlObj.jid.equals("STMAT") || xmlObj.jid.equals("CYA") || xmlObj.jid.equals("DF") || xmlObj.jid.equals("RESU") || xmlObj.jid.equals("ANTRO") || xmlObj.jid.equals("RMB") || xmlObj.jid.equals("REGE") || xmlObj.jid.equals("RAUSP") || xmlObj.jid.equals("RAUSPM") || xmlObj.jid.equals("AIPPRR") || xmlObj.jid.equals("BIOET") || xmlObj.jid.equals("JART") || xmlObj.jid.equals("JBHSI") || xmlObj.jid.equals("RAI")))
								{
									//System.out.println("2 localLang "+localLang);
									//artKwd.append(processKeywords(tag));
									artKwdFranch.append(processKeywords(tag));
//									System.out.println("processKeywords(9)");
									//System.out.println("222222222222222222222222 artKwdFranch "+artKwdFranch);
									...
									artKwd.append(processKeywords(tag));
//									System.out.println("processKeywords(10)");
							...
							else
							{
								//System.out.println("3");
								artKwd.append(processKeywords(tag));
//								System.out.println("processKeywords(11)");
							}
						}
						else
							{
							...
							String llang="";
								if(xmlObj.jid.equalsIgnoreCase("MLA"))
								{
									...
									if(llang.equalsIgnoreCase("DE"))//20/01/2009
										{
											artKwdFranch.append(processKeywords(tag));
//											System.out.println("processKeywords(12)");
											//System.out.println("222222222222222222222222 artKwdFranch "+artKwdFranch);
										...
										{
											artKwd.append(processKeywords(tag));
//											System.out.println("processKeywords(13)");
										}
								...
								{
									artKwd.append(processKeywords(tag));
//									System.out.println("processKeywords(14)");
									if(xmlObj.jid.equalsIgnoreCase("RBCE") || xmlObj.jid.equalsIgnoreCase("REUUUUUUUUU"))
									{
										artKwd.append("}");
									}
								}
							...
							//System.out.println("artKwd "+artKwd);
							//System.out.println("artKwdFranch "+artKwdFranch);
							//System.out.println(" artKwd "+artKwd);
							//System.in.read();
					}
				...
				else if (tag.startsWith("<CE:DATA-AVAILABILITY>") || tag.startsWith("<CE:DATA-AVAILABILITY "))
				{					
					System.out.println("INSIDE :: "+tag);
					while (!tag.equals("</CE:DATA-AVAILABILITY>"))
					{
...
//								System.out.println("INSIDE <CE:SECTION-TITLE> in <CE:DATA-AVAILABILITY>");
								...
								dataAvailability = "\\section{"+dataSec+"}\n\\addbookmark{}{"+dataSec+"}\n";
							}
							else if (tag.equals("<CE:PARA>")||tag.startsWith("<CE:PARA "))
							{
//								System.out.println("INSIDE <CE:PARA> in <CE:DATA-AVAILABILITY>");
								String datapara = xmlObj.extractData("</CE:PARA>", true);
								dataAvailability+= datapara+"\n";
							}
						}
//						System.out.println("TEXT <CE:DATA-AVAILABILITY> :: "+dataAvailability);	
					}
					System.out.println("FINAL <CE:DATA-AVAILABILITY> :: "+dataAvailability);	
				}
				else if (tag.startsWith("<CE:DATE-RECEIVED") || tag.startsWith("<CE:DATE-ACCEPTED") || tag.startsWith("<CE:DATE-REVISED"))
				{
					//Added on 21-01-2018 for new DTD 5.6.0
					if(tag.startsWith("<CE:DATE-ACCEPTED")){
						String accAttVal = xmlObj.getAttributeValue(tag, "ROLE");
						if(accAttVal.indexOf("SUPPRESSED")!=-1){
							System.out.println("Role attribute in "+tag+" is \"suppressed\" in XML, no output required in PDF.");
						}else{
					...
					//Till here.
//					historyDates+= getHistoryDate(tag)+"\r\n";//Commented on 21-01-2018 for new DTD 5.6.0
				}
				...
				else if (tag.equals("<CE:SHORT-TITLE>")||tag.startsWith("<CE:SHORT-TITLE "))
				{
					System.out.println("Short title <CE:SHORT-TITLE> is not required in the PDF.");
				}
						...
						while (!tag.equals("</CE:DOCHEAD>"))
						{
							...
							if (ch1=='<')
							{
								...
								if (tag.equals("<CE:TEXTFN>")||tag.startsWith("<CE:TEXTFN"))
								{
									...
									else if(countTablePara==3)
									{
										subsubartDochead= xmlObj.extractData("</CE:TEXTFN>", true);
										//System.out.println("3. tbCap : "+tbCap);
									}
									else if(countTablePara==4)
									{
										subsubsubartDochead= xmlObj.extractData("</CE:TEXTFN>", true);
										//System.out.println("4. tbCap : "+tbCap);
									}
									else if(countTablePara==5)
									{
										subsubsubsubartDochead= xmlObj.extractData("</CE:TEXTFN>", true);
										//System.out.println("5. tbCap : "+tbCap);
									}
									else if(countTablePara > 5)
									{
										artDochead= xmlObj.extractData("</CE:TEXTFN>", true);
										//System.out.println("6+ tbCap : "+tbCap);
									}
				...
				else if (tag.equals("<CE:MISCELLANEOUS>")||tag.startsWith("<CE:MISCELLANEOUS "))//31-03-2015 JADTD540 Updation
				{
					if(xmlObj.jid.equals("JAMM")){
						if(miscjamm.equals(""))
							miscjamm+= xmlObj.extractData("</CE:MISCELLANEOUS>", true);
						else
							miscjamm+= "\\miscbreak\r\n"+xmlObj.extractData("</CE:MISCELLANEOUS>", true);
					}else if(xmlObj.jid.equalsIgnoreCase("PROTIS")&&dad_check_doc_head==true)
					{
						Move_botton_author_Group_Info.append(xmlObj.extractData("</CE:MISCELLANEOUS>", true));
					}else if((xmlObj.jid.equals("OFTAL")||XT.modelStyle.startsWith("7Spanish"))&& xmlObj.pit.equalsIgnoreCase("prv")){
						if(misc.equals(""))
							misc+= xmlObj.extractData("</CE:MISCELLANEOUS>", true);
						else
		...
		*/
		//if((!XT.modelStyle.equalsIgnoreCase("-MODDFrench"))&&(!XT.modelStyle.equalsIgnoreCase("-MODEFrench"))&&(!XT.modelStyle.startsWith("-MOD6"))&&(!XT.modelStyle.startsWith("6Plus")))//08-04-2015
...
//			if (auNames.size()>=3)//Update on 10-11-2018 for more than 3 author
			//New requirement received for STauthor and RHauthor names
			if (auNames.size()>=3)
			{
				String auName= (String)auNames.get(0);
				String auName2 = (String)auNames.get(1);
				String auName3 = (String)auNames.get(2);
				System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
				System.out.println("auName :::: "+auName);
				System.out.println("auName2 :::: "+auName2);
				System.out.println("auName3 :::: "+auName3);
				...
				String fullfirstname2 = "";
				String fullfirstname3 = "";
				//System.out.println("auName: "+auName);
				String[] aun1 = auName.split(";");
				String[] aun2 = auName2.split(";");
				String[] aun3 = auName3.split(";");
				...
				sn2 = aun2[1];
				sn3 = aun3[1];*/
				sn1 = removeAbbreviation(aun1[1]);
				sn2 = removeAbbreviation(aun2[1]);
				sn3 = removeAbbreviation(aun3[1]);
				...
				{
					if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
						if(fn1.equals(""))
						...
						if (auNames.size()==3){
							STrunAuthors += fn1 +" "+ sn1 +", "+ fn2 +" "+ sn2 +" and "+ fn3 +" "+ sn3;
						}else{
							STrunAuthors += fn1 +" "+ sn1 +", "+ fn2 +" "+ sn2 +", "+ fn3 +" "+ sn3 +" et al.";
						}
					}
				}
				else if(xmlObj.bibStyle.equals("2"))
				{
					if ((xmlObj.jid.equals("SOCECO") && (Integer.parseInt(xmlObj.aid)) >= 1341)||xmlObj.jid.equals("JBECON")||xmlObj.jid.equals("JBEE"))//27-12-2013
					{
						if (auNames.size()==3)
						{
							...
							if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
								STrunAuthors += fullau1+", "+ fullau2+" and "+ fullau3;
							}else{
								STrunAuthors += fn1 +" "+ sn1 +", "+ fn2 +" "+ sn2 +" and "+ fn3 +" "+ sn3;
							}
						}
			...
			//	else if(xmlObj.bibStyle.startsWith("3") || xmlObj.bibStyle.equals("4"))//old
				...
				if(STrunAuthors.endsWith("et al."))
				{
					...
					if(!STrunAuthors.endsWith(", et al."))
					{
						int spos=0;
							...
							if(spos!=-1)
							{
								if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){//Remove comma in case of Article-number//09-10-2019
			  ...
			  //end
				...
				{
					//tempN =auName.substring(0, auName.indexOf(";"));//Commented on 20-06-2013 by Vivek
					tempN =runEmailAuthor(auName.substring(0, auName.indexOf(";")));
					auName=auName.substring(auName.indexOf(";")+1);
				}
				else
				...
				//System.out.println("\n\n1 tempN :"+tempN);
				//System.out.println("2 auName :"+auName);
				//System.out.println("3 runAuthors :"+runAuthors);
				if(!(xmlObj.jid.equalsIgnoreCase("HLC")||xmlObj.jid.equalsIgnoreCase("JPHYS")))
				{
					if(xmlObj.jid.equalsIgnoreCase("BJORL")||xmlObj.jid.equalsIgnoreCase("BJORLP")||xmlObj.jid.equalsIgnoreCase("ENDMAG")||xmlObj.jid.equalsIgnoreCase("ABDP")||xmlObj.jid.equalsIgnoreCase("JPEDP"))
					{
						runAuthors= auName+" ";
						tempN=tempN.replaceAll("\\.","");
						runAuthors+=tempN+" et al.";
						//System.out.println("33 runAuthors :"+runAuthors);
					}
					else
					{
						runAuthors= tempN+" ";
				...
				if(xmlObj.jid.equalsIgnoreCase("NRL")||xmlObj.jid.equals("NRLENG")||xmlObj.jid.equalsIgnoreCase("APRIM")||xmlObj.jid.equalsIgnoreCase("EJPSY")||xmlObj.jid.equalsIgnoreCase("REPOD")||xmlObj.jid.equalsIgnoreCase("RPTOB")||xmlObj.jid.equalsIgnoreCase("RAA")||xmlObj.jid.equalsIgnoreCase("RCHIC")||xmlObj.jid.equalsIgnoreCase("RCHIRA")||xmlObj.jid.equalsIgnoreCase("RPRH")||xmlObj.jid.equalsIgnoreCase("RCHOT")||xmlObj.jid.equalsIgnoreCase("RIEM")||xmlObj.jid.equalsIgnoreCase("CC")||xmlObj.jid.equalsIgnoreCase("EDUMED")||xmlObj.jid.equalsIgnoreCase("CIRGEN")||xmlObj.jid.equalsIgnoreCase("MAGIS")||xmlObj.jid.equalsIgnoreCase("EJFB")||xmlObj.jid.equalsIgnoreCase("EJEPS")||xmlObj.jid.equalsIgnoreCase("ANPSIC")||xmlObj.jid.equalsIgnoreCase("MINCOM")||xmlObj.jid.equalsIgnoreCase("RCHIPE")||xmlObj.jid.equalsIgnoreCase("RCCOT")||xmlObj.jid.equalsIgnoreCase("UROCO")||xmlObj.jid.equalsIgnoreCase("CIRCIR")||xmlObj.jid.equalsIgnoreCase("CIRCEN")||xmlObj.jid.equalsIgnoreCase("RIPS")||xmlObj.jid.equalsIgnoreCase("ACCI")||xmlObj.jid.equalsIgnoreCase("MEI")||xmlObj.jid.equalsIgnoreCase("MEDRE")||xmlObj.jid.equalsIgnoreCase("REU")||xmlObj.jid.equalsIgnoreCase("UROMX")||xmlObj.jid.equalsIgnoreCase("ANCV")||xmlObj.jid.equalsIgnoreCase("ACUP")||xmlObj.jid.equalsIgnoreCase("HGMX")||xmlObj.jid.equalsIgnoreCase("BMHIMX")||xmlObj.jid.equalsIgnoreCase("RARD")||xmlObj.jid.equalsIgnoreCase("RCCAR")||xmlObj.jid.equalsIgnoreCase("PIRO")||xmlObj.jid.equalsIgnoreCase("REIMKE")||xmlObj.jid.equalsIgnoreCase("SJME")||xmlObj.jid.equalsIgnoreCase("EQ")||xmlObj.jid.equalsIgnoreCase("RLP")||xmlObj.jid.equalsIgnoreCase("RMTA")||xmlObj.jid.equalsIgnoreCase("RCCAN")||xmlObj.jid.equalsIgnoreCase("IJCHP")||xmlObj.jid.equalsIgnoreCase("MEXOFT")||xmlObj.jid.equalsIgnoreCase("RAM")||xmlObj.jid.equalsIgnoreCase("BJAN")||xmlObj.jid.equalsIgnoreCase("BJANE")||xmlObj.jid.equalsIgnoreCase("BJANES")||xmlObj.jid.equalsIgnoreCase("CESJEF")||xmlObj.jid.equalsIgnoreCase("SEDENE")||xmlObj.jid.equalsIgnoreCase("SEDENG")||xmlObj.jid.equalsIgnoreCase("RGMX")||xmlObj.jid.equalsIgnoreCase("RLFA")||xmlObj.jid.equalsIgnoreCase("CESJEF")||xmlObj.jid.equals("ANGIO")||xmlObj.jid.equals("RIFK")||xmlObj.jid.equals("REDAR")||xmlObj.jid.equals("REDARE")||xmlObj.jid.equals("REMLE")||xmlObj.jid.equalsIgnoreCase("DIALIS")||xmlObj.jid.equals("RPSM")||xmlObj.jid.equals("AVDIAB")||xmlObj.jid.equals("MEDIPA")||xmlObj.jid.equals("IMADI")||xmlObj.jid.equals("ANDROL")||xmlObj.jid.equals("ACMX")||xmlObj.jid.equals("INFECT")||xmlObj.jid.equals("REML")||xmlObj.jid.equals("PATOL")||xmlObj.jid.equals("FT")||xmlObj.jid.equals("RECOT")||xmlObj.jid.equals("SEMERG")||xmlObj.jid.equals("CALI")||xmlObj.jid.equals("JHQR")||xmlObj.jid.equals("ENDONU")||xmlObj.jid.equals("ENDINU")||xmlObj.jid.equals("SENOL")||xmlObj.jid.equals("REUMA")||xmlObj.jid.equals("REUMAE")||xmlObj.jid.equals("PSIQ")||xmlObj.jid.equals("REMN")||xmlObj.jid.equals("REMNIM")||xmlObj.jid.equals("REMNGL")||xmlObj.jid.equals("REMNIE")||xmlObj.jid.equals("REGG")||xmlObj.jid.equals("PBJ")||xmlObj.jid.equals("RIBA")||xmlObj.jid.equals("APPR")||xmlObj.jid.equals("MEDCLI")||xmlObj.jid.equals("MEDCLE")||xmlObj.jid.equals("APJ")||xmlObj.jid.equals("PSE")||xmlObj.jid.equals("CLYSA")||xmlObj.jid.equals("CLYSA")||xmlObj.jid.equals("RPTO")||xmlObj.jid.equals("GEMREV")||xmlObj.jid.equals("ESPE")||xmlObj.jid.equals("AULA")||xmlObj.jid.equals("EJPAL")||xmlObj.jid.equals("BJP")||xmlObj.jid.equals("JEFAS")||xmlObj.jid.equals("ESTGER")||xmlObj.jid.equals("RAMD")||xmlObj.jid.equals("RCSAR")||xmlObj.jid.equals("PSI")||xmlObj.jid.equals("ANYES")||xmlObj.jid.equals("JIK")||xmlObj.jid.equals("CIRCV")||xmlObj.jid.equals("RPEDM")||xmlObj.jid.equals("CEDE")||xmlObj.jid.equals("BRQ")||xmlObj.jid.equals("RIMNI")||xmlObj.jid.equals("SRFE")||xmlObj.jid.equals("IHE")||xmlObj.jid.equals("REDEE")||xmlObj.jid.equals("REDEEN")||xmlObj.jid.equals("IEDEE")||xmlObj.jid.equals("IEDEEN")||xmlObj.jid.equals("SEMREU")||xmlObj.jid.equals("MCP")||xmlObj.jid.equals("RIAM")||xmlObj.jid.equals("EIMC")||xmlObj.jid.equals("PSICOD")||xmlObj.jid.equals("EIMCE")||xmlObj.jid.equals("PSICOE")||xmlObj.jid.equals("GACETA")||xmlObj.jid.equals("ARBRES")||xmlObj.jid.equals("OPRESP")||xmlObj.jid.equals("ARBR")||xmlObj.jid.equals("ANPEDI")||xmlObj.jid.equals("ANPEDE")||xmlObj.jid.equals("RCE")||xmlObj.jid.equals("RCENG")||xmlObj.jid.equalsIgnoreCase("GINE")||xmlObj.jid.equals("APUNTS")||xmlObj.jid.equals("RPPNEU")||xmlObj.jid.equals("RPPNEN")||xmlObj.jid.equals("PULMOE")||xmlObj.jid.equals("LABCLI")||xmlObj.jid.equals("HIPERT")||xmlObj.jid.equals("ARTERI")||xmlObj.jid.equals("ARTERE")||xmlObj.jid.equals("RH")||xmlObj.jid.equals("ENFI")||xmlObj.jid.equals("ENFIE")||xmlObj.jid.equals("ENFCLI")||xmlObj.jid.equals("ENFCLE")||xmlObj.jid.equalsIgnoreCase("MEDIN")||xmlObj.jid.equalsIgnoreCase("ENDOMX")||xmlObj.jid.equalsIgnoreCase("FARMA")||xmlObj.jid.equalsIgnoreCase("FARMAE")||xmlObj.jid.equalsIgnoreCase("RXENG")||xmlObj.jid.equalsIgnoreCase("REPC")||xmlObj.jid.equals("JPG")||xmlObj.jid.equals("JPGE")||xmlObj.jid.equalsIgnoreCase("REPCE")||xmlObj.jid.equalsIgnoreCase("RXENG")||xmlObj.jid.equalsIgnoreCase("RECOTE")||xmlObj.jid.equalsIgnoreCase("RPSMEN")||xmlObj.jid.equalsIgnoreCase("ENDOEN")||xmlObj.jid.equalsIgnoreCase("ENDIEN")||xmlObj.jid.equalsIgnoreCase("OTOENG")||xmlObj.jid.equalsIgnoreCase("MEDINE")||xmlObj.jid.equalsIgnoreCase("BMHIME")||xmlObj.jid.equalsIgnoreCase("RGMXEN")||xmlObj.jid.equalsIgnoreCase("RX")||xmlObj.jid.equalsIgnoreCase("RCE")||xmlObj.jid.equals("OTORRI")||xmlObj.jid.equals("GASTRO")||xmlObj.jid.equals("GASTRE")||xmlObj.jid.equals("REUMA")||xmlObj.jid.equals("REMN")||xmlObj.jid.equals("EIMC")||xmlObj.jid.equals("ARBIES")||xmlObj.jid.equalsIgnoreCase("ABD")||xmlObj.jid.equalsIgnoreCase("JPED")||xmlObj.jid.equalsIgnoreCase("RPPED")||xmlObj.jid.equalsIgnoreCase("AD")||xmlObj.jid.equalsIgnoreCase("ADENGL")||xmlObj.jid.equalsIgnoreCase("ACURO")||xmlObj.jid.equalsIgnoreCase("ACUROE")||xmlObj.jid.equalsIgnoreCase("RICMA")||xmlObj.jid.equalsIgnoreCase("RPPEDE"))
				{
				...
				else if(xmlObj.jid.equals("JPHYS"))//Updated on 05-04-2014
				{
					runAuthors+=auName+" et al";
				}
				else if(xmlObj.jid.equals("REGE"))//Updated on 06-07-2016
				{
					runAuthors+=auName+" et al";
				}
				else if(xmlObj.jid.equals("BJORL")||xmlObj.jid.equals("BJORLP")||xmlObj.jid.equals("ENDMAG")||xmlObj.jid.equalsIgnoreCase("ABDP")||xmlObj.jid.equals("JPEDP"))
				{
					//runAuthors+=auName+" et al.";//Not required, as the condition is already updated on line no 3149.
				}
				else if(xmlObj.jid.equals("HYA") || xmlObj.jid.equals("STMAT") || xmlObj.jid.equals("CYA") || xmlObj.jid.equals("DF") || xmlObj.jid.equals("RESU") || xmlObj.jid.equals("ANTRO"))
				{
					runAuthors+=auName+" et al.";
				}
				else
...
//							STrunAuthors += sn1 +" "+ fn1.replaceAll("\\.","");
				...
				else if(!(xmlObj.jid.equalsIgnoreCase("HLC")||xmlObj.jid.equalsIgnoreCase("JPHYS")))
				{
					runAuthors= tempN+" ";
					runAuthors+=auName;
					//System.out.println("runAuthors :"+runAuthors);
			...
			{
				//System.out.println("Check condition for rhauthor=================================");
				String auName= (String)auNames.get(0);
				String auName2 = (String)auNames.get(1);
				...
				if(xmlObj.bibStyle.startsWith("1"))
				{
					if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
						...
						STrunAuthors += fn1 +" "+ sn1 +" and "+ fn2 +" "+ sn2;
					}
				}
				else if(xmlObj.bibStyle.equals("2"))
				{
					...
					*/
					...
					if ((xmlObj.jid.equals("SOCECO") && (Integer.parseInt(xmlObj.aid)) >= 1341)||xmlObj.jid.equals("JBECON")||xmlObj.jid.equals("JBEE"))//27-12-2013)
					{
						...
						{
							if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
								STrunAuthors += sn1 +", "+ fn1 +" and "+ fn2 +" "+ sn2;
							}else{
								STrunAuthors += fn1 +" "+ sn1 +" and "+ fn2 +" "+ sn2;
							}
						}
						...
						{
							STrunAuthors += sn1 +" and "+ fn2 +" "+ sn2;
							
						}
						else if((fn1.length() > 0) && (fn2.length()==0))
						{
							if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
								STrunAuthors += sn1 +", "+ fn1+" and "+ sn2 ;
							}else{
								STrunAuthors += fn1 +" "+ sn1 +" and "+ sn2;
							}
						}
						else if((fn1.length()== 0) && (fn2.length()==0))
						{
				...
				{
					//System.out.println("Check condition for rhauthor=================================2");
					if(initials_check==true)
					{
						if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
							STrunAuthors += sn1 +" "+ fn1 +", "+ sn2 +" "+ fn2;
					...
					*/
					if(xmlObj.bibStyle.startsWith("5"))
					{
						if((fn1.length() > 0) && (fn2.length()>0))
						{
							...
							//STrunAuthors += sn1 +", "+ fn1.replaceAll("\\.",". ").trim() +", \\& "+ sn2 +", "+ fn2.replaceAll("\\."," ").trim();
							//31-08-2015
							if(XT.articleType.equalsIgnoreCase("ES") && xmlObj.check_SpanishJid==true){
								if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
									STrunAuthors += sn1 +", "+ fn1.replaceAll("\\.",". ").trim() +", y "+ sn2 +", "+ fn2.trim();
								}else{
									STrunAuthors += fn1 +" "+ sn1 +", y "+ fn2 +" "+ sn2;
								}
							}else{
								if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
									STrunAuthors += sn1 +", "+ fn1.replaceAll("\\.",". ").trim() +", \\& "+ sn2 +", "+ fn2.trim();
						...
						else if((fn1.length() == 0) && (fn2.length()>0))
						{
							...
							if(XT.articleType.equalsIgnoreCase("ES") && xmlObj.check_SpanishJid==true){
								if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
									STrunAuthors += sn1 +", "+ sn2 +", y "+ fn2.replaceAll("\\."," ").trim();
								}else{
									STrunAuthors += sn1 +", y "+ fn2 +" "+ sn2;
								}
							}else{
								if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
						...
						else if((fn1.length() > 0) && (fn2.length()==0))
						{
							if(XT.articleType.equalsIgnoreCase("ES") && xmlObj.check_SpanishJid==true){
								if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
									STrunAuthors += sn1 +", "+ fn1.replaceAll("\\.",". ").trim() +", y "+ sn2 ;
								}else{
									STrunAuthors += fn1 +" "+ sn1 +", y "+ sn2;
								}
							}else{
								if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
			...
			else if((xmlObj.jid.equalsIgnoreCase("COCOMP") && xmlObj.bibStyle.equalsIgnoreCase("5")))
			{
				...
				else
				{
					...
					if(xmlObj.jid.equalsIgnoreCase("HLC")||xmlObj.jid.equalsIgnoreCase("PROTIS")||xmlObj.jid.equalsIgnoreCase("IMR")||xmlObj.jid.equalsIgnoreCase("JPHYS"))
					{
					...
					{
						runAuthors+=auName+", ";
						//System.out.println(" AIP STrunAuthors---->"+runAuthors);
					}
				}
//				System.out.println("initials_check===> "+initials_check);
				...
				if(initials_check)
				{
					//auName= (String)auNamesRhauthor.get(1);//14-03-2016
					auName= (String)auNamesRhauthor.get(0);
					//System.out.println("auName===> "+auName);
				}
				else
			...
			if(xmlObj.jid.equalsIgnoreCase("JPED")||xmlObj.jid.equalsIgnoreCase("JPEDP")||xmlObj.jid.equalsIgnoreCase("ABDOLD")||xmlObj.jid.equalsIgnoreCase("ABDPOLD")||xmlObj.jid.equalsIgnoreCase("RPPED")||xmlObj.jid.equalsIgnoreCase("RPPEDE")||xmlObj.jid.equalsIgnoreCase("RBCE"))
			{
				runAuthors=STrunAuthors;
				if(runAuthors.endsWith("et al"))
				{
					runAuthors=runAuthors.replaceAll(", et al"," et al");
					if(!runAuthors.endsWith(".")){
						runAuthors+=".";
					}
				}
			}
		...
		*/
		...
		if(((xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX")))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||(xmlObj.pit.equalsIgnoreCase("EDI")) ||(xmlObj.pit.equalsIgnoreCase("PGL")&& xmlObj.check_MassonJid==false)|| (xmlObj.pit.equalsIgnoreCase("REQ")) || (xmlObj.pit.equalsIgnoreCase("EXM")&&!xmlObj.jid.equalsIgnoreCase("VACUN")) ||(xmlObj.pit.equalsIgnoreCase("PRP"))||(xmlObj.pit.equalsIgnoreCase("COR")&&!xmlObj.jid.equalsIgnoreCase("jalcom")) ||(xmlObj.pit.equalsIgnoreCase("CNF")&&!xmlObj.jid.equalsIgnoreCase("JCV")) || (xmlObj.jid.equals("DNAREP") && (artDochead.equalsIgnoreCase("Classics in DNA Repair") || artDochead.equalsIgnoreCase("Historical reflections") || artDochead.toUpperCase().startsWith("HOT TOPICS IN DNA REPAIR")))||(xmlObj.jid.equalsIgnoreCase("PROTIS")&&HeadGroup.dad_check_doc_head==true)) && !xmlObj.jid.equalsIgnoreCase("HLC"))
			//JALCOM added by mukesh on 07-01-09&& (xmlObj.pit.equalsIgnoreCase("COR")&&!xmlObj.jid.equalsIgnoreCase("jalcom"))
		{
			...
			if(artDochead.length() > 0 && (!xmlObj.jid.equalsIgnoreCase("JAMM")&&(xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||xmlObj.pit.equalsIgnoreCase("EDI")||xmlObj.pit.equalsIgnoreCase("PGL")||xmlObj.pit.equalsIgnoreCase("REQ")||(xmlObj.pit.equalsIgnoreCase("EXM")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))||xmlObj.pit.equalsIgnoreCase("PRP")||xmlObj.pit.equalsIgnoreCase("COR")||xmlObj.pit.equalsIgnoreCase("CNF"))))
			{
				//Added on 05-09-2018, mail by R&D/Georgette
				if(((XT.modelStyle.toUpperCase().startsWith("-MODDFRENCH"))||(XT.modelStyle.toUpperCase().startsWith("-MODEFRENCH"))) && (xmlObj.pit.equalsIgnoreCase("ABS")||xmlObj.pit.equalsIgnoreCase("BPH")||xmlObj.pit.equalsIgnoreCase("BRV")||xmlObj.pit.equalsIgnoreCase("CAL")||xmlObj.pit.equalsIgnoreCase("CNF")||xmlObj.pit.equalsIgnoreCase("COR")||xmlObj.pit.equalsIgnoreCase("EDI")||xmlObj.pit.equalsIgnoreCase("EXM")||xmlObj.pit.equalsIgnoreCase("IND")||xmlObj.pit.equalsIgnoreCase("LIT")||xmlObj.pit.equalsIgnoreCase("NWS")||xmlObj.pit.equalsIgnoreCase("PRP"))){
					if(artDochead.length() > 0){
						if(XT.isPPEworkflow(xmlObj.jid, xmlObj.aid)){
							temp+= "\\rhauthor{"+STrunAuthors+"}\r\n";
						}else{
			...
			else if((runAuthors.length()>0 && xmlObj.check_SpanishJid==true)&& (!xmlObj.jid.equalsIgnoreCase("JAMM")&&(xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||xmlObj.pit.equalsIgnoreCase("EDI")||xmlObj.pit.equalsIgnoreCase("PGL")||xmlObj.pit.equalsIgnoreCase("REQ")||(xmlObj.pit.equalsIgnoreCase("EXM")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))||xmlObj.pit.equalsIgnoreCase("PRP")||xmlObj.pit.equalsIgnoreCase("COR")||xmlObj.pit.equalsIgnoreCase("CNF"))))
			{
				...
				runAuthors=q1.toString();
				//*************************************************
				if(xmlObj.jid.equalsIgnoreCase("PALWOR") && forPalwol)
				{
					runAuthors=runAuthors.replaceAll("ThomsonDigitalCloseBrace", "");
					runAuthors=runAuthors.replaceAll("-", "");
				...
				if(((XT.modelStyle.toUpperCase().startsWith("-MODDFRENCH"))||(XT.modelStyle.toUpperCase().startsWith("-MODEFRENCH"))) && (xmlObj.pit.equalsIgnoreCase("ABS")||xmlObj.pit.equalsIgnoreCase("BPH")||xmlObj.pit.equalsIgnoreCase("BRV")||xmlObj.pit.equalsIgnoreCase("CAL")||xmlObj.pit.equalsIgnoreCase("CNF")||xmlObj.pit.equalsIgnoreCase("COR")||xmlObj.pit.equalsIgnoreCase("EDI")||xmlObj.pit.equalsIgnoreCase("EXM")||xmlObj.pit.equalsIgnoreCase("IND")||xmlObj.pit.equalsIgnoreCase("LIT")||xmlObj.pit.equalsIgnoreCase("NWS")||xmlObj.pit.equalsIgnoreCase("PRP"))){
					if(artDochead.length() > 0){
						...
						if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
							...
							temp+= "\\rhauthor{"+STrunAuthors.replaceAll(", et al", " et al")+"}\r\n";
						}
					}
				}else{
					if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
...
//				temp+= "\\rhauthor{"+runAuthors+"}\r\n";
			...
			else if(artTitle.length()>0 && (!xmlObj.jid.equalsIgnoreCase("JAMM")&&(xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||xmlObj.pit.equalsIgnoreCase("EDI")||xmlObj.pit.equalsIgnoreCase("PGL")||xmlObj.pit.equalsIgnoreCase("REQ")||(xmlObj.pit.equalsIgnoreCase("EXM")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))||xmlObj.pit.equalsIgnoreCase("PRP")||xmlObj.pit.equalsIgnoreCase("COR")||xmlObj.pit.equalsIgnoreCase("CNF"))))
			{
				//System.out.println("22222222222222222222");
				//*****************[New Requirement]***************
				/**
...
//				temp+= "\\rhauthor{"+art+"}\r\n";
			...
			else if(runAuthors.length()>0 && (xmlObj.jid.equalsIgnoreCase("JAMM")&&(xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||xmlObj.pit.equalsIgnoreCase("EDI")||xmlObj.pit.equalsIgnoreCase("PGL")||xmlObj.pit.equalsIgnoreCase("REQ")||(xmlObj.pit.equalsIgnoreCase("EXM")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))||xmlObj.pit.equalsIgnoreCase("PRP")||xmlObj.pit.equalsIgnoreCase("COR")||xmlObj.pit.equalsIgnoreCase("CNF"))))
			{
...
//				temp+= "\\rhauthor{"+runAuthors+"}\r\n";
				if(!ArticleNumberCutoff(xmlObj.jid, xmlObj.aid) || xmlObj.jid.equalsIgnoreCase("ABDOLD") || xmlObj.jid.equalsIgnoreCase("ABDPOLD")){
//					System.out.println("RUNNING HEAD===>"+runAuthors);
				}else{
					System.out.println("RUNNING HEAD===>"+STrunAuthors);
				}
				if(XT.stampJid.contains(xmlObj.pit))//abhay 26/07/2006
				{
					//*****************[New Requirement]***************
		...
		{
			if(runAuthors.length()>0 && forAuthor!=true)
			{
				//*****************[New Requirement]***************
				/**
				 *Added By : Ravi 
				...
				if(XT.stampJid.contains(xmlObj.pit)||((xmlObj.jid.equalsIgnoreCase("DAD")) && (xmlObj.pit.equalsIgnoreCase("NWS"))))//abhay 26/07/2006
				{
					...
					if(xmlObj.jid.equalsIgnoreCase("PALWOR") && forPalwol)
					{
						STrunAuthors=STrunAuthors.replaceAll("ThomsonDigitalCloseBrace", "");
						STrunAuthors=STrunAuthors.replaceAll("-", "");
					}									
					temp += "\\STauthor{"+STrunAuthors+"}\r\n";
					//System.out.println("\n\n\ntemp 333"+STrunAuthors);
		...
		{
			if((xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))) || ((xmlObj.pit.equalsIgnoreCase("COR") && !xmlObj.jid.equalsIgnoreCase("JALCOM"))  ||(xmlObj.pit.equalsIgnoreCase("CNF")&&!xmlObj.jid.equalsIgnoreCase("JCV"))))
			{
				...
				else
				{
					...
					String artDocheaddiff=artDochead;
					artDocheaddiff=artDocheaddiff.replaceAll("ThomsonDiff\\\\_ThomsonDiffOpenBrace([0-9]+)ThomsonDiffCloseBrace","");
					if((xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))) && xmlObj.jid.equalsIgnoreCase("COCOMP"))
					{
					...
					else if(xmlObj.pit.equalsIgnoreCase("cor") && artDocheaddiff.equalsIgnoreCase("Dermatoscopia pr{\\ASaacute}ctica") && xmlObj.jid.equalsIgnoreCase("AD"))
					{
						temp +=  "\\title{"+artTitle;
					}
					else
			...
			*/
			...
			else
			{
				...
				else
				{
					...
					{
						if(subTitle.length()>0 && forAuthor!=true)//bhavesh 17/08/06
						{
		...
		if( !(artTitle.length() > 1) && !(xmlObj.bibStyle.equalsIgnoreCase("1a")) )// abhay 23/09/2006
		{
			...
			//*****************[New Requirement]***************
								...
								//*************************************************
								*/
			if(XT.stampJid.contains(xmlObj.pit) && forAuthor!=true)
			{
				temp += "\\STtitle{"+ artDochead +"}\r\n";
				//System.out.println("----------------------");;
			}
		...
		if(presented.length()>0)
		{
			...
			if((xmlObj.pit.equalsIgnoreCase("brv") || xmlObj.pit.equalsIgnoreCase("PRV")) && xmlObj.jid.equalsIgnoreCase("COCOMP"))
				...
				temp+=presented+"\r\n";
			else if(((xmlObj.pit.equalsIgnoreCase("brv")) || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||(xmlObj.pit.equalsIgnoreCase("EDI")&& (AFJU_Editorial_comment==false)&&(!xmlObj.jid.equalsIgnoreCase("JASCERNOTREQ"))) ||(xmlObj.pit.equalsIgnoreCase("PGL")&& xmlObj.check_MassonJid==false)|| (xmlObj.pit.equalsIgnoreCase("REQ")) || (xmlObj.pit.equalsIgnoreCase("EXM")&& (!xmlObj.jid.equalsIgnoreCase("NEUARG")&&!xmlObj.jid.equalsIgnoreCase("RAMB")&&!xmlObj.jid.equalsIgnoreCase("RCA")&&!xmlObj.jid.equalsIgnoreCase("RCAE")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))) ||(xmlObj.pit.equalsIgnoreCase("PRP"))||(xmlObj.pit.equalsIgnoreCase("COR")) || (xmlObj.pit.equalsIgnoreCase("CNF")&&!xmlObj.jid.equalsIgnoreCase("JCV")) || (xmlObj.jid.equals("DNAREP") && (artDochead.equalsIgnoreCase("Classics in DNA Repair") || artDochead.equalsIgnoreCase("Historical reflections") || artDochead.toUpperCase().startsWith("HOT TOPICS IN DNA REPAIR")))) && !xmlObj.jid.equalsIgnoreCase("HLC"))
			{
				endData+= presented+"\r\n";
...
//			System.out.println("artDochead::"+artDochead);
//			System.out.println("subartDochead::"+subartDochead);
//			System.out.println("subsubartDochead::"+subsubartDochead);
//			System.out.println("subsubsubartDochead::"+subsubsubartDochead);
//			System.out.println("subsubsubsubartDochead::"+subsubsubsubartDochead);
			String move_dochead="";
			if(subsubsubsubartDochead.length()>0)
			{
				move_dochead="\\dochead{"+artDochead+"}\r\n";
				move_dochead+="\\subdochead{"+subartDochead+"}\r\n";
				move_dochead+="\\subsubdochead{"+subsubartDochead+"}\r\n";
				move_dochead+="\\subsubsubdochead{"+subsubsubartDochead+"}\r\n";
				move_dochead+="\\subsubsubsubdochead{"+subsubsubsubartDochead+"}\r\n";
			}else if(subsubsubartDochead.length()>0)
			{
				move_dochead="\\dochead{"+artDochead+"}\r\n";
				move_dochead+="\\subdochead{"+subartDochead+"}\r\n";
				move_dochead+="\\subsubdochead{"+subsubartDochead+"}\r\n";
				move_dochead+="\\subsubsubdochead{"+subsubsubartDochead+"}\r\n";
			}else if(subsubartDochead.length()>0)
			{
				move_dochead="\\dochead{"+artDochead+"}\r\n";
				move_dochead+="\\subdochead{"+subartDochead+"}\r\n";
				move_dochead+="\\subsubdochead{"+subsubartDochead+"}\r\n";
			}else if(subartDochead.length()>0)
			{
				move_dochead="\\dochead{"+artDochead+"}\r\n";
				move_dochead+="\\subdochead{"+subartDochead+"}\r\n";
			}
			...
			else
			{
				...
				if(subsubartDochead.length()>0)
				{
					temp+= "\\subsubdochead{"+subsubartDochead+"}\r\n";
				}
				if(subsubsubartDochead.length()>0)
				{
					temp+= "\\subsubsubdochead{"+subsubsubartDochead+"}\r\n";
				}
				if(subsubsubsubartDochead.length()>0)
				{
					temp+= "\\subsubsubsubdochead{"+subsubsubsubartDochead+"}\r\n";
				}
			}
			//end 
			//System.out.println("===> "+temp);
...
//System.out.println("authorInfo.length() : "+authorInfo.length());
		...
		if (artAbs.length()>0 || artKwd.length()>0||artKwdFranch.length()>0)
		{
			if(modelDHeadContent)
			{
				if(temp.indexOf("\\miscTitle{",0)==-1 || temp.indexOf("Alttitle{",0)==-1)
				{
					temp+=  "\r\n\\startabstract{%\r\n";
				}
			}
		...
		if(artKwd.length() > 0||artKwdFranch.length()>0)
		{
			...
			//artKwdFranch
			String orcpaid=xmlObj.aid;
			if(orcpaid.indexOf(".",0)!=-1)
			{
				orcpaid=orcpaid.substring(0,orcpaid.indexOf(".",0));
			}
			if((xmlObj.jid.equalsIgnoreCase("NEUCLI")|| (xmlObj.jid.equalsIgnoreCase("ENCEP") && Integer.parseInt(xmlObj.aid)<796)|| xmlObj.jid.equalsIgnoreCase("QUIP")|| xmlObj.jid.equalsIgnoreCase("SEXOL")||xmlObj.jid.equalsIgnoreCase("OTSR")||xmlObj.jid.equalsIgnoreCase("JOCLIM")||xmlObj.jid.equalsIgnoreCase("SODA")||xmlObj.jid.equalsIgnoreCase("LIVER")||xmlObj.jid.equalsIgnoreCase("DEMAN")||xmlObj.jid.equalsIgnoreCase("STLM")||xmlObj.jid.equalsIgnoreCase("ANNDER")||(xmlObj.jid.equalsIgnoreCase("RCOT") && Integer.parseInt(orcpaid)<=1032)||xmlObj.jid.equalsIgnoreCase("RCO")||xmlObj.jid.equalsIgnoreCase("JVS")||xmlObj.jid.equalsIgnoreCase("JCHIRV")||xmlObj.jid.equalsIgnoreCase("JCHIR")||xmlObj.jid.equalsIgnoreCase("ANNPAT")||xmlObj.jid.equalsIgnoreCase("FEMME")||xmlObj.jid.equalsIgnoreCase("CND")||xmlObj.jid.equalsIgnoreCase("MEDPAL")||xmlObj.jid.equalsIgnoreCase("EURTEL")||xmlObj.jid.equalsIgnoreCase("REVHOM")||xmlObj.jid.equalsIgnoreCase("JCCO")||xmlObj.jid.equalsIgnoreCase("JEUREA")||xmlObj.jid.equalsIgnoreCase("NEURAD")||xmlObj.jid.equalsIgnoreCase("IMMBIO")||xmlObj.jid.equalsIgnoreCase("MORPHO")||xmlObj.jid.equalsIgnoreCase("JMV")||xmlObj.jid.equalsIgnoreCase("JDMV")||xmlObj.jid.equalsIgnoreCase("BANM")|| xmlObj.jid.equalsIgnoreCase("REAURG")||xmlObj.jid.equalsIgnoreCase("GCB")||(xmlObj.jid.equalsIgnoreCase("CLINRE"))||(xmlObj.jid.equalsIgnoreCase("CLINRE"))||(xmlObj.jid.equalsIgnoreCase("NEUADO")&&(XT.fmcforall==true))||xmlObj.jid.equalsIgnoreCase("PRATAN")||xmlObj.jid.equalsIgnoreCase("ANICOM")||xmlObj.jid.equalsIgnoreCase("VETCLI")||xmlObj.jid.equalsIgnoreCase("NRL")||xmlObj.jid.equals("NRLENG")||xmlObj.jid.equalsIgnoreCase("APRIM")||xmlObj.jid.equalsIgnoreCase("EJPSY")||xmlObj.jid.equalsIgnoreCase("REPOD")||xmlObj.jid.equalsIgnoreCase("RPTOB")||xmlObj.jid.equalsIgnoreCase("RAA")||xmlObj.jid.equalsIgnoreCase("RCHIC")||xmlObj.jid.equalsIgnoreCase("RCHIRA")||xmlObj.jid.equalsIgnoreCase("RPRH")||xmlObj.jid.equalsIgnoreCase("RCHOT")||xmlObj.jid.equalsIgnoreCase("RIEM")||xmlObj.jid.equalsIgnoreCase("CC")||xmlObj.jid.equalsIgnoreCase("EDUMED")||xmlObj.jid.equalsIgnoreCase("CIRGEN")||xmlObj.jid.equalsIgnoreCase("MAGIS")||xmlObj.jid.equalsIgnoreCase("EJFB")||xmlObj.jid.equalsIgnoreCase("EJEPS")||xmlObj.jid.equalsIgnoreCase("ANPSIC")||xmlObj.jid.equalsIgnoreCase("MINCOM")||xmlObj.jid.equalsIgnoreCase("RCHIPE")||xmlObj.jid.equalsIgnoreCase("RCCOT")||xmlObj.jid.equalsIgnoreCase("UROCO")||xmlObj.jid.equalsIgnoreCase("SD")||xmlObj.jid.equalsIgnoreCase("SDCAT")||xmlObj.jid.equalsIgnoreCase("SDENG")||xmlObj.jid.equalsIgnoreCase("CIRCIR")||xmlObj.jid.equalsIgnoreCase("CIRCEN")||xmlObj.jid.equalsIgnoreCase("EII")||xmlObj.jid.equalsIgnoreCase("RIPS")||xmlObj.jid.equalsIgnoreCase("ACCI")||xmlObj.jid.equalsIgnoreCase("MEI")||xmlObj.jid.equalsIgnoreCase("MEDRE")||xmlObj.jid.equalsIgnoreCase("REU")||xmlObj.jid.equalsIgnoreCase("UROMX")||xmlObj.jid.equalsIgnoreCase("ANCV")||xmlObj.jid.equalsIgnoreCase("ACUP")||xmlObj.jid.equalsIgnoreCase("HGMX")||xmlObj.jid.equalsIgnoreCase("BMHIMX")||xmlObj.jid.equalsIgnoreCase("RARD")||xmlObj.jid.equalsIgnoreCase("RCCAR")||xmlObj.jid.equalsIgnoreCase("PIRO")||xmlObj.jid.equalsIgnoreCase("REIMKE")||xmlObj.jid.equalsIgnoreCase("SJME")||xmlObj.jid.equalsIgnoreCase("EQ")||xmlObj.jid.equalsIgnoreCase("RLP")||xmlObj.jid.equalsIgnoreCase("RMTA")||xmlObj.jid.equalsIgnoreCase("RCCAN")||xmlObj.jid.equalsIgnoreCase("BJORL")||xmlObj.jid.equalsIgnoreCase("BJORLP")||xmlObj.jid.equalsIgnoreCase("ENDMAG")||xmlObj.jid.equalsIgnoreCase("IJCHP")||xmlObj.jid.equalsIgnoreCase("MEXOFT")||xmlObj.jid.equalsIgnoreCase("RAM")||xmlObj.jid.equalsIgnoreCase("BJAN")||xmlObj.jid.equalsIgnoreCase("BJANE")||xmlObj.jid.equalsIgnoreCase("BJANES")||xmlObj.jid.equalsIgnoreCase("CESJEF")||xmlObj.jid.equalsIgnoreCase("SEDENE")||xmlObj.jid.equalsIgnoreCase("SEDENG")||xmlObj.jid.equalsIgnoreCase("RGMX")||xmlObj.jid.equalsIgnoreCase("RLFA")||xmlObj.jid.equalsIgnoreCase("CESJEF")||xmlObj.jid.equals("ANGIO")||xmlObj.jid.equals("RIFK")||xmlObj.jid.equals("REDAR")||xmlObj.jid.equals("REDARE")||xmlObj.jid.equals("REMLE")||xmlObj.jid.equalsIgnoreCase("DIALIS")||xmlObj.jid.equals("RPSM")||xmlObj.jid.equals("AVDIAB")||xmlObj.jid.equals("MEDIPA")||xmlObj.jid.equals("IMADI")||xmlObj.jid.equals("ANDROL")||xmlObj.jid.equals("ACMX")||xmlObj.jid.equals("INFECT")||xmlObj.jid.equals("REML")||xmlObj.jid.equals("PATOL")||xmlObj.jid.equals("FT")||xmlObj.jid.equals("RECOT")||xmlObj.jid.equals("SEMERG")||xmlObj.jid.equals("CALI")||xmlObj.jid.equals("JHQR")||xmlObj.jid.equals("ENDONU")||xmlObj.jid.equals("ENDINU")||xmlObj.jid.equals("SENOL")||xmlObj.jid.equals("REUMA")||xmlObj.jid.equals("REUMAE")||xmlObj.jid.equals("PSIQ")||xmlObj.jid.equals("REMN")||xmlObj.jid.equals("REMNIM")||xmlObj.jid.equals("REMNGL")||xmlObj.jid.equals("REMNIE")||xmlObj.jid.equals("REGG")||xmlObj.jid.equals("PBJ")||xmlObj.jid.equals("RIBA")||xmlObj.jid.equals("APPR")||xmlObj.jid.equals("MEDCLI")||xmlObj.jid.equals("MEDCLE")||xmlObj.jid.equals("APJ")||xmlObj.jid.equals("PSE")||xmlObj.jid.equals("CLYSA")||xmlObj.jid.equals("CLYSA")||xmlObj.jid.equals("RPTO")||xmlObj.jid.equals("GEMREV")||xmlObj.jid.equals("ESPE")||xmlObj.jid.equals("AULA")||xmlObj.jid.equals("EJPAL")||xmlObj.jid.equals("BJP")||xmlObj.jid.equals("RBE")||xmlObj.jid.equals("JEFAS")||xmlObj.jid.equals("ESTGER")||xmlObj.jid.equals("RAMD")||xmlObj.jid.equals("RCSAR")||xmlObj.jid.equals("PSI")||xmlObj.jid.equals("ANYES")||xmlObj.jid.equals("JIK")||xmlObj.jid.equals("CIRCV")||xmlObj.jid.equals("RPEDM")||xmlObj.jid.equals("CEDE")||xmlObj.jid.equals("BRQ")||xmlObj.jid.equals("RIMNI")||xmlObj.jid.equals("SRFE")||xmlObj.jid.equals("IHE")||xmlObj.jid.equals("REDEE")||xmlObj.jid.equals("REDEEN")||xmlObj.jid.equals("IEDEE")||xmlObj.jid.equals("IEDEEN")||xmlObj.jid.equals("SEMREU")||xmlObj.jid.equals("MCP")||xmlObj.jid.equals("RIAM")||xmlObj.jid.equals("EIMC")||xmlObj.jid.equals("PSICOD")||xmlObj.jid.equals("EIMCE")||xmlObj.jid.equals("PSICOE")||xmlObj.jid.equals("GACETA")||xmlObj.jid.equals("ARBRES")||xmlObj.jid.equals("OPRESP")||xmlObj.jid.equals("ARBR")||xmlObj.jid.equalsIgnoreCase("ABD")||xmlObj.jid.equalsIgnoreCase("ABDP")||xmlObj.jid.equalsIgnoreCase("JPED")||xmlObj.jid.equalsIgnoreCase("RPPED")||xmlObj.jid.equalsIgnoreCase("AD")||xmlObj.jid.equalsIgnoreCase("JPEDP")||xmlObj.jid.equalsIgnoreCase("ADENGL")||xmlObj.jid.equalsIgnoreCase("ACURO")||xmlObj.jid.equalsIgnoreCase("ACUROE")||xmlObj.jid.equalsIgnoreCase("RICMA")||xmlObj.jid.equalsIgnoreCase("RPPEDE")||xmlObj.jid.equals("ANPEDI")||xmlObj.jid.equals("ANPEDE")||xmlObj.jid.equals("RCE")||xmlObj.jid.equals("RCENG")||xmlObj.jid.equalsIgnoreCase("FARMA")||xmlObj.jid.equalsIgnoreCase("FARMAE")||xmlObj.jid.equalsIgnoreCase("RXENG")||xmlObj.jid.equalsIgnoreCase("REPC")||xmlObj.jid.equals("JPG")||xmlObj.jid.equals("JPGE")||xmlObj.jid.equalsIgnoreCase("REPCE")||xmlObj.jid.equalsIgnoreCase("RXENG")||xmlObj.jid.equalsIgnoreCase("RECOTE")||xmlObj.jid.equalsIgnoreCase("RPSMEN")||xmlObj.jid.equalsIgnoreCase("ENDOEN")||xmlObj.jid.equalsIgnoreCase("ENDIEN")||xmlObj.jid.equalsIgnoreCase("OTOENG")||xmlObj.jid.equalsIgnoreCase("MEDINE")||xmlObj.jid.equalsIgnoreCase("BMHIME")||xmlObj.jid.equalsIgnoreCase("RGMXEN")||xmlObj.jid.equalsIgnoreCase("RX")||xmlObj.jid.equalsIgnoreCase("RCE")||xmlObj.jid.equalsIgnoreCase("TEKHNE")||xmlObj.jid.equalsIgnoreCase("ALLER")||xmlObj.jid.equalsIgnoreCase("GAMO")||xmlObj.jid.equalsIgnoreCase("RMU")||xmlObj.jid.equalsIgnoreCase("OPTOM")||xmlObj.jid.equalsIgnoreCase("BJPT")||xmlObj.jid.equals("OTORRI")||xmlObj.jid.equals("GASTRO")||xmlObj.jid.equals("GASTRE")||xmlObj.jid.equalsIgnoreCase("GINE")||xmlObj.jid.equals("APUNTS")||xmlObj.jid.equals("RPPNEU")||xmlObj.jid.equals("RPPNEN")||xmlObj.jid.equals("PULMOE")||xmlObj.jid.equals("LABCLI")||xmlObj.jid.equals("HIPERT")||xmlObj.jid.equals("ARTERI")||xmlObj.jid.equals("ARTERE")||xmlObj.jid.equals("RH")||xmlObj.jid.equals("ENFI")||xmlObj.jid.equals("ENFIE")||xmlObj.jid.equals("ENFCLI")||xmlObj.jid.equals("ENFCLE")||xmlObj.jid.equalsIgnoreCase("MEDIN")||xmlObj.jid.equalsIgnoreCase("ENDOMX") || xmlObj.jid.equalsIgnoreCase("JGYN")||xmlObj.jid.equalsIgnoreCase("AFJU")||(xmlObj.jid.equalsIgnoreCase("MLA")&&XT.modelStyle.equalsIgnoreCase("6PlusGerman"))||xmlObj.jid.equalsIgnoreCase("AFORL")||xmlObj.jid.equalsIgnoreCase("ANORL")||xmlObj.jid.equalsIgnoreCase("JTCC")||xmlObj.jid.equalsIgnoreCase("JBCT")||xmlObj.jid.equalsIgnoreCase("ETIQE")||xmlObj.jid.equalsIgnoreCase("PUROL")||xmlObj.jid.equalsIgnoreCase("NPG")||xmlObj.jid.equalsIgnoreCase("PHARMA")||xmlObj.jid.equalsIgnoreCase("SAGF")||xmlObj.jid.equalsIgnoreCase("PNEUMO")||xmlObj.jid.equalsIgnoreCase("DOULER")||xmlObj.jid.equalsIgnoreCase("ACVD") ||xmlObj.jid.equalsIgnoreCase("JFO")||xmlObj.jid.equalsIgnoreCase("MLONG")||xmlObj.jid.equalsIgnoreCase("LONGEV")||xmlObj.jid.equalsIgnoreCase("RMR")||xmlObj.jid.equalsIgnoreCase("PEDPUE")||xmlObj.jid.equalsIgnoreCase("ANNDEROLD")||xmlObj.jid.equalsIgnoreCase("FANDER")||xmlObj.jid.equalsIgnoreCase("ACVDSP")||xmlObj.jid.equalsIgnoreCase("THERAP")||xmlObj.jid.equalsIgnoreCase("JEMEP")||xmlObj.jid.equalsIgnoreCase("REFIRI")||xmlObj.jid.equalsIgnoreCase("TOXAC")||xmlObj.jid.equalsIgnoreCase("ONCOHP")||xmlObj.jid.equalsIgnoreCase("JRADIO")||xmlObj.jid.equalsIgnoreCase("JRDIA")||xmlObj.jid.equalsIgnoreCase("DIII")||(xmlObj.jid.equalsIgnoreCase("TRACLI")&&(XT.fmcforall==true))||xmlObj.jid.equalsIgnoreCase("MSOM")||(xmlObj.jid.equalsIgnoreCase("JTS")&&(XT.fmcforall==true))||(xmlObj.jid.equalsIgnoreCase("SCISPO")&&(Integer.parseInt(XT.plusTable.get(xmlObj.jid).toString())<=Integer.parseInt(intaid(xmlObj.aid))))))
			{
				
				//System.out.println("KKKKKKKKEEEEEEYYYYY WWWWWWOOOOOOORRRRRRRDDDDDDSSSSSSSS");
...
//						System.out.println("I AM HERE-3....................................................");
						//System.out.println("INSIDE ARTKWD CONDITION...");
						int i=s.indexOf("\\ENGcopyright\r\n%\\end{abstract}",0);
						//System.out.println("1 Ravi temp : "+i+" uuuu"+s);
						if(i!=-1)
						{
//							System.out.println("I AM HERE-4a....................................................");
							s=s.insert(i+"\\ENGcopyright\r\n".length(),"\r\n\\keywords{%"+artKwd+"}\r\n");
							//System.out.println("1 Ravi temp : ");

							//Below new condition added on 24-09-2016 
							if(artKwdFranch.length() > 0){
//								System.out.println("Final String 1 :: "+s);
								//SEARCH MISSING KEYWORDS HERE
								int p=s.indexOf("\\PORTcopyright\r\n\\end{abstract}",0);
								System.out.println("PORT KEYWORDS FOUND::"+artKwdFranch+" p:"+p);
								if(p!=-1 && (xmlObj.jid.equalsIgnoreCase("CYA") || xmlObj.jid.equalsIgnoreCase("DF") || xmlObj.jid.equalsIgnoreCase("ANTRO") || xmlObj.jid.equalsIgnoreCase("RMB") || xmlObj.jid.equalsIgnoreCase("REGE") || xmlObj.jid.equalsIgnoreCase("RAUSP") || xmlObj.jid.equalsIgnoreCase("RAUSPM"))){
//									System.out.println("PORTUGUESE===============>"+s);
									s=s.insert(s.indexOf("\\PORTcopyright",0)+"\\PORTcopyright".length(),"\r\n\\keywords{%"+artKwdFranch+"}");
//									System.out.println("Final String :: "+s);
						...
						{
//							System.out.println("I AM HERE-4b....................................................");
							if(XT.modelStyle.equalsIgnoreCase("5PlusFrench")){//Added on 20-03-2017 missing keywords in duck & duckling item
								System.out.println("MODEL 5PlusFrench FOUND...");
								if(xmlObj.aid.contains(".")){
									System.out.println("KeywordsFrench Length::"+artKwdFranch.length());
									System.out.println("Keywords Length::"+artKwd.length());
									i=s.indexOf("\\end{abstract}",0);
									if(i!=-1)
									{
										s=s.insert(i+"\\end{abstract}".length(),"\r\n\\keywords{%"+artKwd+"}");
										System.out.println("Keywords added in abstract for 5PlusFrench model.");
									}
								}
							}

							
//							System.out.println("INSIDE I NOT - -1 CONDITION...");
							if(artKwdFranch.length() > 0)
							{
...
//											System.out.println("I AM HERE....................................................");
											...
											if(i!=-1)
											{
//												System.out.println("KEYWORDS FOUND:"+artKwdFranch);
												s=s.insert(i+"\\ENGcopyright\r\n".length(),"\r\n\\keywords{%"+artKwd+"}\r\n");
												int j=s.indexOf("\\SPcopyright\r\n%\\end{abstract}",0);
												if(j!=-1 && (xmlObj.jid.equalsIgnoreCase("HYA") || xmlObj.jid.equalsIgnoreCase("STMAT") || xmlObj.jid.equalsIgnoreCase("CYA") || xmlObj.jid.equalsIgnoreCase("DF") || xmlObj.jid.equalsIgnoreCase("RESU") || xmlObj.jid.equalsIgnoreCase("ANTRO") || xmlObj.jid.equalsIgnoreCase("RMB") || xmlObj.jid.equalsIgnoreCase("REGE") || xmlObj.jid.equalsIgnoreCase("RAUSP") || xmlObj.jid.equalsIgnoreCase("RAUSPM") || xmlObj.jid.equalsIgnoreCase("AIPPRR") || xmlObj.jid.equalsIgnoreCase("BIOET") || xmlObj.jid.equalsIgnoreCase("JART") || xmlObj.jid.equalsIgnoreCase("JBHSI") || xmlObj.jid.equalsIgnoreCase("RAI")))
												{
													s=s.insert(s.indexOf("%\\end{abstract}",0),"\\keywords{%"+artKwdFranch+"}\r\n");
												}
												else
												{
													//PORTcopyright condition added on 10-05-2016 for REGE
													int p=s.indexOf("\\PORTcopyright\r\n%\\end{abstract}",0);
													System.out.println("PORT KEYWORDS FOUND::"+artKwdFranch+" p:"+p);
													if(p!=-1 && (xmlObj.jid.equalsIgnoreCase("HYA") || xmlObj.jid.equalsIgnoreCase("STMAT") || xmlObj.jid.equalsIgnoreCase("CYA") || xmlObj.jid.equalsIgnoreCase("DF") || xmlObj.jid.equalsIgnoreCase("RESU") || xmlObj.jid.equalsIgnoreCase("ANTRO") || xmlObj.jid.equalsIgnoreCase("RMB") || xmlObj.jid.equalsIgnoreCase("REGE") || xmlObj.jid.equalsIgnoreCase("RAUSP") || xmlObj.jid.equalsIgnoreCase("RAUSPM") || xmlObj.jid.equalsIgnoreCase("AIPPRR") || xmlObj.jid.equalsIgnoreCase("BIOET") || xmlObj.jid.equalsIgnoreCase("JART") || xmlObj.jid.equalsIgnoreCase("JBHSI") || xmlObj.jid.equalsIgnoreCase("RAI"))){
//														System.out.println("PORTUGUESE===============>"+s);
														s=s.insert(s.indexOf("%\\end{abstract}",0),"\\keywords{%"+artKwdFranch+"}\r\n");
													}else{
//														System.out.println("OTHER==========>"+s);
					...
					if(artKwdFranch.length() > 0)
					{
						...
						if(XT.modelStyle.equalsIgnoreCase("5PlusFrench")){//Added on 20-03-2017 missing keywords in duck & duckling item
							...
							if(xmlObj.aid.contains(".")){
								System.out.println("KeywordsFrench Length::"+artKwdFranch.length());
								System.out.println("Keywords Length::"+artKwd.length());
								int i=s.indexOf("\\end{abstract}",0);
								if(i!=-1)
								{
									s=s.insert(i+"\\end{abstract}".length(),"\r\n\\keywords{%"+artKwdFranch+"}");
									System.out.println("Keywords added in abstract for 5PlusFrench model.");
						...
						if(j!=-1 && (xmlObj.jid.equalsIgnoreCase("HYA") || xmlObj.jid.equalsIgnoreCase("STMAT") || xmlObj.jid.equalsIgnoreCase("CYA") || xmlObj.jid.equalsIgnoreCase("DF") || xmlObj.jid.equalsIgnoreCase("RESU") || xmlObj.jid.equalsIgnoreCase("ANTRO") || xmlObj.jid.equalsIgnoreCase("RMB") || xmlObj.jid.equalsIgnoreCase("REGE") || xmlObj.jid.equalsIgnoreCase("RAUSP") || xmlObj.jid.equalsIgnoreCase("RAUSPM") || xmlObj.jid.equalsIgnoreCase("AIPPRR") || xmlObj.jid.equalsIgnoreCase("BIOET") || xmlObj.jid.equalsIgnoreCase("JART") || xmlObj.jid.equalsIgnoreCase("JBHSI") || xmlObj.jid.equalsIgnoreCase("RAI")))
						{
							//System.out.println ("KKKKKK"+" iiii  "+i+" == "+s);
							s=s.insert(j+"\\SPcopyright\r\n".length(),"\\keywords{%"+artKwdFranch+"}\r\n");
							//System.out.println("23 Ravi temp : ");
						}
						else
						{
							//System.out.println ("\\FRcopyright\r\n\\end{abstract} NOT FOUND");
						}
				...
				{
				 //artKwdFranch
					 if(xmlObj.jid.equalsIgnoreCase("RBCE") || xmlObj.jid.equalsIgnoreCase("REU"))
					{
						if(artKwd.length()>0)
						{
							//temp+= "\r\n\\keywords{%"+artKwd+"}";
					...
					else if(XT.articleType.equalsIgnoreCase("EN"))
					 {
						if(artKwd.length()>0)
						{
							temp+= "\r\n\\keywords{%"+artKwd+"}";
			...
			if(temp.indexOf("\\miscTitle{",0)!=-1)
			{
				...
				if(start_position!=-1)
				{
					...
					if(last_position>0)
					{
						...
						if(xmlObj.pit.equalsIgnoreCase("brv") && modelDHeadContent)
						{
							brvAltTitle=brvAltTitle.replaceAll("Alttitle", "miscAlttitle");
							temp += brvAltTitle+"}";
						}
					}
				...
				if(temp.indexOf("\\Alttitle{",0)!=-1)
				{
					...
					if(start_position!=-1)
					{
						...
						if(last_position>0)
						{
							...
							if(modelDHeadContent && !Tempkey.equalsIgnoreCase(""))
							{
								System.out.println("Tempkey :::"+Tempkey);
								temp+=  "\r\n\\startabstract{%\r\n";
								temp+= Tempkey+"}}";
		...
		*/
		...
		//HeadGroup_Collab checkcor=new HeadGroup_Collab(xmlObj);	
		//checkcor.processAuthorGroup();
		String checkCorrespondance=HeadGroup_Collab.checkCorres;		
		if(authorCorrespondences.length ()>0)
		{
			...
			if (!(xmlObj.jid.equals("EMT") && xmlObj.pit.equals("PNT"))) // 30-11-2004
			{
				...
				else if((xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))) && xmlObj.jid.equalsIgnoreCase("COCOMP"))
		...
		if(checkCorrespondance.length()>0 && checkCorrespondance !=null)
		{
			temp+="\r\n"+checkCorrespondance;
		}
...
if(historyDates.length()>0 || presented.length()>0 || misc.length()>0)
		...
		if(reference.length()>0)  ////EXTRANET
		{
			...
			else
			{
				...
				*/
				//Updated on 02-03-2015 for book reference in misctitle in new tag
				//<other-ref> to be checked ???
				if(xt.chekJidAid(xmlObj.jid.trim().toUpperCase(), xmlObj.aid.trim().toUpperCase())){
					temp+="\r\n\\REFmiscTitle{"+reference+"}\r\n";
				}else{
					temp+="\r\n\\miscTitle{"+reference+"}\r\n";
				}
				//System.out.println("temp 1211 --> "+temp);
	...
	public String processKeywords(String tag)throws java.io.IOException
	{
		...
		}else if(XT.modelStyle.startsWith("7Spanish")){
			String val=GetVal(count_keywords);
			String val1=GetVal(count_JAL_keywords);
			if(kwdClass.equalsIgnoreCase("JEL")){
				if(val1.equalsIgnoreCase("one")){
					jelkey = true;
					keywords.append("}\r\n\\JELKey"+val1+"{%");
				}else{
					jelkey = true;
					...
					{	
						...
						else
						{
							if(kwdLang.equalsIgnoreCase("FR"))
								...
								keywords.append("\r\n\\ITKWDtitle{"+kwdTitle+" }\r\n");
							else if(xmlObj.jid.equals("RBCE") || xmlObj.jid.equals("REUUUUUUUUU"))
							{
								//System.out.println("KEYWORDS DOUBLING CONDITION...");
								kwdCountRbce++;
 								if(kwdLang.equalsIgnoreCase("en"))
								{
									if(kwdCountRbce==1)
									{
										//System.out.println(xmlObj.jid+" Original 111 Keywords::"+keywords);
										keywords.append("\r\n\\keywords{%");
										keywords.append("\r\n\\KWDtitle{"+kwdTitle+"}\r\n");
										//keywords.append("}");										
									}
									if(kwdCountRbce==2)
									{
										//System.out.println(xmlObj.jid+" Original 222 Keywords::"+keywords);
										keywords.append("\r\n\\keywordsone{%");
										keywords.append("\r\n\\KWDtitle{"+kwdTitle+"}\r\n");	
										//keywords.append("}");
									}
									if(kwdCountRbce==3)
									{
										//System.out.println(xmlObj.jid+" Original 333 Keywords::"+keywords);
										keywords.append("\r\n\\keywordstwo{%");
										keywords.append("\r\n\\KWDtitle{"+kwdTitle+"}\r\n");
										//keywords.append("}");
									}
								...
								if(kwdLang.equalsIgnoreCase("pt"))
								{
									if(kwdCountRbce==1)
									{
										keywords.append("\r\n\\keywords{%");
								...
								if(kwdLang.equalsIgnoreCase("es"))
								{
									if(kwdCountRbce==1)
									{
										keywords.append("\r\n\\keywords{%");
								...
								if(XT.modelStyle.startsWith("7Spanish")){
									if(jelkey){
										if(kwdClass.equalsIgnoreCase("JEL"))
											keywords.append("\r\n\\KWDtitle{"+kwdTitle+"}\r\n");
										else if(kwdLang.equalsIgnoreCase(XT.articleType))
											keywords.append("}\r\n\\KWDtitle{"+kwdTitle+"}\r\n");
										else
											keywords.append("\r\n\\KWDtitle{"+kwdTitle+"}\r\n");
									}else{
...
//					System.out.println(eTag);//System.exit(0);
	...
	public String processAuthorGroup() throws java.io.IOException
	{
		...
		String tag                         = "";
		StringBuffer authorInfo            =  new StringBuffer();
		StringBuffer modAuthorInfo         =  new StringBuffer();
		StringBuffer modAuthorInfoTwo         =  new StringBuffer();
		...
		String coll_authorAffiliations="";//19-12-2012
		XT dsf=new XT();
		boolean forPalwol=dsf.forpalworVal;
		...
		//countAuthor=0; 
		XT modXt=new XT();
		boolean modelD=modXt.chekJidAid(xmlObj.jid, xmlObj.aid);
		...
		while (!tag.equals("</CE:AUTHOR-GROUP>"))
		{
			...
			if (ch=='<')
			{
				...
				{
					//commneted by avinanda
//					collabInfo.append("\r\n\\collabauthor{"+xmlObj.extractData("</CE:TEXT>", true)+"}");
					//end mark
					//added by avinandan
					/*
					*Data : 06/08/2008
					 ...
					 long filePointer=fin.getFilePointer();//28-08-2012 JADTD520 updation
						...
						while((!statTag1.equals("</CE:COLLABORATION>")))
						{
							...
							if (ch=='<')
							{
								...
								{
									author_colb+=xmlObj.extractData("</CE:TEXT>", true)+"\r\n";
								}
								if(statTag1.startsWith("<CE:CROSS-REF"))
								{
									if (statTag1.indexOf("REFID=\"")>0)
									{
										String crID = statTag1;
										crID=crID.replaceAll(" ID=\"([a-zA-z]+)([0-9]+)\"","");
										//System.out.println("crID==>"+crID);
										int spos=crID.indexOf("<CE:CROSS-REF REFID=\"");
										int epos=crID.indexOf(">",spos);
										crID = crID.substring(spos+21,epos-1);
										//System.out.println("spos==>"+spos);
										//System.out.println("epos==>"+epos);
										//System.out.println("crID==>"+crID);
										crID="\\protect\\specialhyperlink{"+xmlObj.jid+xmlObj.aid+crID+"}{";
										author_colb=author_colb.trim();
										author_colb+=crID+xmlObj.extractData("</CE:CROSS-REF>", true)+"}";
									}
									else
									{
										author_colb=author_colb.trim();
										author_colb+=xmlObj.extractData("</CE:CROSS-REF>", true);
									}
								}
								else if (statTag1.startsWith("<CE:E-ADDRESS"))
								{
									//System.out.println("\nCE:E-ADDRESS FOUND IN CE:COLLABORATION");
									String givenName       = "";
									String eaddType= xmlObj.getAttributeValue(tag, "TYPE");
									String emailCont = new String();
//									System.out.println("ETYPE of E-ADDRESS::"+eaddType);
									...
									}else if(eaddType.equals("SOCIAL-MEDIA"))
									{
										System.out.println("Extracting Social-Media content...");
										if(url.length ()>0)
										{
											url+=", ";
											UrlCount++;
								...
								else if(statTag1.startsWith("<CE:AUTHOR-GROUP"))
								{
									...
									HeadGroup_Collab JD520=new HeadGroup_Collab(xmlObj);//19-12-2012
									author_colb+=JD520.processAuthorGroup();									
									//coll_authorAffiliations
									String JD_temp=author_colb;
									if(JD_temp.indexOf("<cut>",0)!=-1)
									{
										JD_temp=JD_temp.substring(JD_temp.indexOf("<cut>",0),JD_temp.lastIndexOf("</cut>"));
										JD_temp=JD_temp.replaceAll("<cut>","");
										JD_temp=JD_temp.replaceAll("</cut>","");
										coll_authorAffiliations=JD_temp;
										author_colb=author_colb.substring(0,author_colb.indexOf("<cut>",0));
				...
				else if (tag.startsWith("<CE:AUTHOR"))
				{
					...
					String authorAlias     = "";//21-10-2019 DTD 5.6.0 Updation
					String authRoles       = "";
					String modAuthRoles    = "";
					String auAff           = "";
					String auCor           = "";
					...
					int degStatus          =0;
					String order = "";//rajeev
					int contributorRoleCount = 0;
					String orcidID         = "";//Added on 02-02-2019
					...
					if(orcidJID(xmlObj.jid, xmlObj.aid)){
						orcidID= xmlObj.getAttributeValue(tag, "ORCID");
					}
					System.out.println("ORCID ID :: "+orcidID);
					...
					while (!tag.equals("</CE:AUTHOR>"))
					{
						...
						{
							tag= xmlObj.getTag().toUpperCase();
//							System.out.println("TTTTTTAAAAAAGGGGGGG ::::::: "+tag);
							...
							else if (tag.equals("<CE:GIVEN-NAME>"))
							{
								...
								if(xmlObj.jid.equalsIgnoreCase("PALWOR") && forPalwol)
								{
									...
									givenName=givenName.replaceAll("ThomsonDigitalMiddle", "");
									//givenName=givenName.replaceAll("\\\\_", "");
									givenName=givenName.replaceAll("LITAuThomsonDigitalOpenBrace", "");
									//givenName=givenName.replaceAll("ThomsonDiff", "");
									//givenName=givenName.replaceAll("ThomsonDiff", "");
									//givenName=givenName.replaceAll("OpenBrace([0-9]+)", "");
									//givenName=givenName.replaceAll("CloseBrace", "");
							...
							else if (tag.equals("<CE:ROLES>"))
							{
									...
									if(modelD==true)
									{
										//modAuthRoles= xmlObj.extractData("</CE:ROLES>", true);
										//modAuthRoles="{"+modAuthRoles+"}";
										modAuthRoles=authRoles;
									}
								
							}
							else if (tag.equals("<CE:ALIAS>"))
							{								
								authorAlias= " \\alias{"+xmlObj.extractData("</CE:ALIAS>", true)+"}";
								//System.out.println("authorAlias===>>"+authorAlias);
							}
							else if (tag.equals("<CE:SURNAME>"))
							{								
								surName= xmlObj.extractData("</CE:SURNAME>", true);
							}
							else if (tag.startsWith("<CE:CONTRIBUTOR-ROLE "))
							{
								if(contributorRole.isEmpty()){
									contributorRole = "\\section{CRediT authorship contribution statement}\n\\addbookmark{}{CRediT authorship contribution statement}\n";
								}
								if(contributorRoleCount>0){
									contributorRole+= ", "+xmlObj.extractData("</CE:CONTRIBUTOR-ROLE>", true);
								}else{
									if(givenName.length()>0 && surName.length()>0){
										contributorRole+= "{\\bf{"+givenName+" "+surName+":}} ";
									}else if(givenName.length()>0){
										contributorRole+= "{\\bf{"+givenName+":}} ";
									}else if(surName.length()>0){
										contributorRole+= "{\\bf{"+surName+":}} ";
									}
									contributorRole+= xmlObj.extractData("</CE:CONTRIBUTOR-ROLE>", true);
								}
							...
							else if (tag.startsWith("<CE:E-ADDRESS"))
							{
								...
								String eaddType= xmlObj.getAttributeValue(tag, "TYPE");
								String emailCont = new String();
//								System.out.println("Type of E-ADDRESS::"+eaddType);
								emailCont = xmlObj.extractData("</CE:E-ADDRESS>", true);
								String eaddLink=xmlObj.getAttributeValue(tag, "XLINK:HREF");
//								System.out.println("E-ADDRESS_XLINK:HREF :: "+eaddLink);
								//System.out.println("--------------"+emailCont);
								if(eaddType.equals("EMAIL")||eaddType.equals(""))
								{
									...
									if(XT.DucklingOrderStatus==true && xmlObj.MassonJidList.contains(xmlObj.jid)){
										tempead=" \\DnDName{ ("+runEmailAuthor(givenName)+" "+removeAbbreviation(surName);
									}else{
										tempead=" ("+runEmailAuthor(givenName)+" "+removeAbbreviation(surName);
									}
									
									/*if(xmlObj.jid.equalsIgnoreCase("PALWOR"))
									{
										tempead =tempead.replaceAll("-", "");
									}*/									
									if(xmlObj.jid.equalsIgnoreCase("PALWOR") && forPalwol)
									{
										tempead =tempead.replaceAll("ThomsonDigitalCloseBrace", "");
										tempead =tempead.replaceAll("-", "");										
									}
...
//									System.out.println("ead==> "+ead);
								...
								*/
								...
								}else if(eaddType.equals("SOCIAL-MEDIA"))
								{
									...
									url+="\\smedia{"+eaddLink.toLowerCase()+"}{"+emailCont+"}{}";
									//url+="\\url{"+url+"}{"+url+"}{}";
									//System.out.println("====>>"+url);
										String tempurl="";
										tempurl=" ("+runEmailAuthor(givenName)+" "+surName;
									...
									if(url.indexOf(eaddLink+""+tempurl)!=-1)
									{
										url+=tempurl;
									}
									else if(url.indexOf(tempurl)!=-1 && (tempurl.indexOf(givenName+surName) != -1))
					...
					if(modelD)
					{
						modAuthorInfo.append("\\AuRolepicture{");
					}
					authorInfo.append("\\author{");
					//System.out.println(" ::authorInfo :: "+authorInfo);

					Move_Author_tag+="\\author{";//18/12/2007
					if(absAuthor.indexOf("\\author{")>0)
					{
						absAuthor.append(",\r\n\\author{");//Avinandan
					}
					else
					...
					else
					{
						...
						{							
									...
									XT.QueryVector.contains("Por favor verifique se o nome pr&oacute;prio e apelido(s) est&atilde;o identificados corretamente. As diferentes cores sinalizam que foram etiquetados como nome ou apelido. Tenha em aten&ccedil;&atilde;o que a identifica&ccedil;&atilde;o adequada &eacute; essencial para uma indexa&ccedil;&atilde;o correta do artigo.")))//02-08-2011
							{
								...
								if(modelD==true)
								{
									modAuthorInfo.append(givenName+" ");
								}
						...
						if(surName.length()>0)
						{
									...
									XT.QueryVector.contains("Por favor verifique se o nome pr&oacute;prio e apelido(s) est&atilde;o identificados corretamente. As diferentes cores sinalizam que foram etiquetados como nome ou apelido. Tenha em aten&ccedil;&atilde;o que a identifica&ccedil;&atilde;o adequada &eacute; essencial para uma indexa&ccedil;&atilde;o correta do artigo.")))//02-08-2011
							{
								...
								if(xmlObj.jid.equalsIgnoreCase("PALWOR") && forPalwol)
								{
									surName=surName.replaceAll("ThomsonDigitalCloseBrace","");
					...
					if(suffixName.length()>0)
					{
						...
						//System.out.println("authorInfo "+authorInfo);
						//System.out.println("suffixName "+suffixName);
						//System.out.println("eextraAuthor "+eextraAuthor);
					}
					if((degree.length()>0) && (degStatus==2))
					{
					...
					if(authRoles.length()>0)
					{
						if(((xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX")))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||(xmlObj.pit.equalsIgnoreCase("EDI")&& AFJU_Editorial_comment==false&&(!xmlObj.jid.equalsIgnoreCase("JASCERNOTREQ")))||(xmlObj.pit.equalsIgnoreCase("PGL")&& xmlObj.check_MassonJid==false) || (xmlObj.pit.equalsIgnoreCase("REQ")) || (xmlObj.pit.equalsIgnoreCase("EXM")&& (!xmlObj.jid.equalsIgnoreCase("NEUARG")&&!xmlObj.jid.equalsIgnoreCase("RAMB")&&!xmlObj.jid.equalsIgnoreCase("RCA")&&!xmlObj.jid.equalsIgnoreCase("RCAE")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))) ||(xmlObj.pit.equalsIgnoreCase("PRP"))||(xmlObj.pit.equalsIgnoreCase("COR")) || (xmlObj.pit.equalsIgnoreCase("CNF")&&!xmlObj.jid.equalsIgnoreCase("JCV")) || (xmlObj.jid.equals("DNAREP") && (artDochead.equalsIgnoreCase("Classics in DNA Repair") || artDochead.equalsIgnoreCase("Historical reflections") || artDochead.toUpperCase().startsWith("HOT TOPICS IN DNA REPAIR")))) && !xmlObj.jid.equalsIgnoreCase("HLC"))
						{
							if(authorInfo.lastIndexOf("\\author{") != -1)
								authorInfo.insert(authorInfo.lastIndexOf("\\author{"),authRoles);
						}
						else
						{
					...
					if(authorAlias.length()>0){
						authorInfo.append(authorAlias);//21-01-2019 DTD 5.6.0 Updation
						Move_Author_tag+=authorAlias;//18/12/2007
						absAuthor.append(authorAlias);//11/05/2009
						eextraAuthor+=authorAlias;
					}
					if(orcidID.length()>0){
						authorInfo.append("\\protect\\orcidID{"+orcidID+"}");
						Move_Author_tag+="\\protect\\orcidID{"+orcidID+"}";
						absAuthor.append("\\protect\\orcidID{"+orcidID+"}");
						eextraAuthor+="\\protect\\orcidID{"+orcidID+"}";
					}
				...
				else if (tag.startsWith("<CE:AFFILIATION"))
				{
					...
					if(affId.length()>0)
					{
						...
						/**
						*Modify Date : [20/03/2007]
						* Added By : Arvind
						* Change Point : In MISC case no required Ids and affiliation case need blank {}
						*Change Request By : Vivek
						*/
						//authorAffiliations.append("["+affId+"]");//old
						if((xmlObj.pit.equalsIgnoreCase("COR") || xmlObj.pit.equalsIgnoreCase("BRV") ||  (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))||  xmlObj.pit.equalsIgnoreCase("PRP") ||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||  xmlObj.pit.equalsIgnoreCase("EDI")||(xmlObj.pit.equalsIgnoreCase("PGL")&& xmlObj.check_MassonJid==false) ||  (xmlObj.pit.equalsIgnoreCase("CNF")&&!xmlObj.jid.equalsIgnoreCase("JCV")) ||  (xmlObj.pit.equalsIgnoreCase("EXM")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))))
						{
							/**
							*Modify Date : [20/03/2007]
							* Added By : Arvind
							...
							*/
							if((xmlObj.pit.equalsIgnoreCase("COR") && xmlObj.jid.equalsIgnoreCase("JALCOM")))
							{
									...
									//System.out.println("xmlObj.pit==> "+xmlObj.pit);
							}
						...
						else
						{
							...
							authorAffiliations.append("["+affId+"]");
							//System.out.println("111xmlObj.pit==> "+affId);
					...
					/**
					*Modify Date : [05/04/2007]
					* Added By : Arvind
					* Change Point : In JALCOM Journal Affiliation should be \affliation{Text} in case of non MISC article.
					*Change Request By : Vivek
					*/
					if(affId.length() <= 0 && ((xmlObj.pit.equalsIgnoreCase("COR")) && (xmlObj.jid.equalsIgnoreCase("JALCOM"))))
					{authorAffiliations.append("{");}
					else if((affId.length() <= 0 && AFJU_Editorial_comment)||(affId.length() <= 0 && ((xmlObj.pit.equalsIgnoreCase("EXM")) && (xmlObj.jid.equalsIgnoreCase("NEUARG")||xmlObj.jid.equalsIgnoreCase("RAMB")||xmlObj.jid.equalsIgnoreCase("RCA")||xmlObj.jid.equalsIgnoreCase("RCAE"))) ||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||(xmlObj.pit.equalsIgnoreCase("EDI")&& (xmlObj.jid.equalsIgnoreCase("JASCERNOTREQ")))))
					{authorAffiliations.append("{");}
					/**
					*Modify Date : [20/03/2007]
					* Added By : Arvind
					...
					*Change Request By : Vivek
					*/
					//authorAffiliations.append("{");//old
					else if(affId.length() <= 0 && (xmlObj.pit.equalsIgnoreCase("COR")|| xmlObj.pit.equalsIgnoreCase("PRP")|| xmlObj.pit.equalsIgnoreCase("REQ") || xmlObj.pit.equalsIgnoreCase("BRV") ||  (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX"))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||  xmlObj.pit.equalsIgnoreCase("EDI")||(xmlObj.pit.equalsIgnoreCase("PGL")&& xmlObj.check_MassonJid==false)||  (xmlObj.pit.equalsIgnoreCase("CNF")&&!xmlObj.jid.equalsIgnoreCase("JCV")) ||  (xmlObj.pit.equalsIgnoreCase("EXM")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))))
					{authorAffiliations.append("{}{");}
					else
					{
						authorAffiliations.append("{");
					...
					{
						//if(authorInfo.length()>0 && authorInfo.indexOf("\\author{")!=-1)
							//authorAffiliations.append(authorInfo.substring(8,authorInfo.length()-1)+", ");
							// Added by mukesh on 06-09-08 for removing <BR>
						if(authorInfo.length()>0 && authorInfo.indexOf("\\author{")!=-1)
						{
							//System.out.println("authorInfo : "+authorInfo);
					...
					//System.out.println("authorAffiliations :"+authorAffiliations.toString());
					...
					/*if(((xmlObj.pit.equalsIgnoreCase("brv") || xmlObj.pit.equalsIgnoreCase("PRV"))||(xmlObj.pit.equalsIgnoreCase("EDI")) || (xmlObj.pit.equalsIgnoreCase("REQ")) || (xmlObj.pit.equalsIgnoreCase("EXM")) ||(xmlObj.pit.equalsIgnoreCase("PRP"))||(xmlObj.pit.equalsIgnoreCase("COR") || xmlObj.pit.equalsIgnoreCase("CNF")) || (xmlObj.jid.equals("DNAREP") && (artDochead.equalsIgnoreCase("Classics in DNA Repair") || artDochead.equalsIgnoreCase("Historical reflections") || artDochead.toUpperCase().startsWith("HOT TOPICS IN DNA REPAIR")))) && !xmlObj.jid.equalsIgnoreCase("HLC"))
					{
						affs.put(affId, authorAffiliations);
						authorAffiliations = new StringBuffer();
					}*/
				}
				else if (tag.startsWith("<CE:CORRESPONDENCE"))
				{
					...
					if(((xmlObj.pit.equalsIgnoreCase("brv") || (xmlObj.pit.equalsIgnoreCase("PRV")&&!xmlObj.jid.equalsIgnoreCase("ENDOMXXXXX")))||(xmlObj.pit.equalsIgnoreCase("DIS")&&xmlObj.jid.equalsIgnoreCase("JPHYS"))||(xmlObj.pit.equalsIgnoreCase("EDI")&&AFJU_Editorial_comment==false&&(!xmlObj.jid.equalsIgnoreCase("JASCERNOTREQ"))) ||(xmlObj.pit.equalsIgnoreCase("PGL")&& xmlObj.check_MassonJid==false)|| (xmlObj.pit.equalsIgnoreCase("REQ")) || (xmlObj.pit.equalsIgnoreCase("EXM")&& (!xmlObj.jid.equalsIgnoreCase("NEUARG")&&!xmlObj.jid.equalsIgnoreCase("RAMB")&&!xmlObj.jid.equalsIgnoreCase("RCA")&&!xmlObj.jid.equalsIgnoreCase("RCAE")&&!xmlObj.jid.equalsIgnoreCase("VACUN"))) ||(xmlObj.pit.equalsIgnoreCase("PRP"))||((xmlObj.pit.equalsIgnoreCase("COR")  && !xmlObj.jid.equalsIgnoreCase("JALCOM"))) || (xmlObj.pit.equalsIgnoreCase("CNF")&&!xmlObj.jid.equalsIgnoreCase("JCV")) || (xmlObj.jid.equals("DNAREP") && (artDochead.equalsIgnoreCase("Classics in DNA Repair") || artDochead.equalsIgnoreCase("Historical reflections") || artDochead.toUpperCase().startsWith("HOT TOPICS IN DNA REPAIR")))) && !xmlObj.jid.equalsIgnoreCase("HLC"))
					{
					...
					else
					{
						...
						else
						{
							...
							authorCorrespondences.append("\\Correspondingauthor{\\hypertarget{"+xmlObj.jid+xmlObj.aid+corId+"}{}"+corValue+"}");
				...
				else if (tag.startsWith("<CE:FOOTNOTE"))
				{
					...
					if(authorFootnotes.length()>0)
						...
						{							
							...
							System.out.println("authorFootnotes :: "+authorFootnotes);
						}
		...
		*/				
		...
		else
		{
			...
			temp= authorInfo.toString();
//			System.out.println("0 authorInfo ::> "+authorInfo.toString());
			if(modelD)
			{
				
				String modAuthInfoTemp = modAuthorInfoTwo.toString();
				temp = temp+"\n"+modAuthInfoTemp;
//				System.out.println("modAuthorInfoTwo ::>  "+modAuthorInfo);				
			}
		...
		*/
		if(authorAffiliations.length()>0)
			temp+= "\r\n"+authorAffiliations;
		if(coll_authorAffiliations.length()>0)
			temp+= "\r\n"+coll_authorAffiliations;
		//end
		...
		System.out.println("contributorRole ::\r\n"+contributorRole);
		return temp;
	}
	...
	{	
		...
		*/
		...
		//end
			...
			//System.out.println("fnm : "+fnm);
		//System.in.read();
		//Updated on 05-11-2015, requirement received by Sumit Shridhar via mail
		if(XT.jid.equalsIgnoreCase("RPPED")||XT.jid.equalsIgnoreCase("RPPEDE")){
			//da”, “de”, “do”, “e” ‘van der’, ‘de la’, ‘von’,//Values exist in StyleSheet
			if(fnm.startsWith("de ")||fnm.startsWith("do ")||fnm.startsWith("da ")){
				fnm=fnm.substring(3,fnm.length());
			}
			if(fnm.startsWith("e ")){
				fnm=fnm.substring(2,fnm.length());
			}
			if(fnm.startsWith("van der ")){
				fnm=fnm.substring(8,fnm.length());
			}
			if(fnm.startsWith("de la ")){
				fnm=fnm.substring(6,fnm.length());
			}
			if(fnm.startsWith("von ")){
				fnm=fnm.substring(4,fnm.length());
			}
			
			if(fnm.endsWith(" de")||fnm.endsWith(" do")||fnm.endsWith(" da")){
				fnm=fnm.substring(0,fnm.length()-3);
			}
			if(fnm.endsWith(" e")){
				fnm=fnm.substring(0,fnm.length()-2);
			}
			if(fnm.endsWith(" van der")){
				fnm=fnm.substring(0,fnm.length()-8);
			}
			if(fnm.endsWith(" de la")){
				fnm=fnm.substring(0,fnm.length()-6);
			}
			if(fnm.endsWith(" von")){
				fnm=fnm.substring(0,fnm.length()-4);
			}
			
			fnm=fnm.replaceAll(" de ", " ");
			fnm=fnm.replaceAll(" do ", " ");
			fnm=fnm.replaceAll(" da ", " ");
			fnm=fnm.replaceAll(" e ", " ");
			fnm=fnm.replaceAll(" van der ", " ");
			fnm=fnm.replaceAll(" de la ", " ");
			fnm=fnm.replaceAll(" von ", " ");
		}
//		System.out.println("FNM before:"+fnm);
		if(isBrazilianAuthor(xmlObj.jid, xmlObj.aid)){
			//da”, “de”, “do”, “e” ‘van der’, ‘de la’, ‘von’,//Values exist in StyleSheet
			if(fnm.startsWith("de ")||fnm.startsWith("da ")||fnm.startsWith("do ")){
				fnm=fnm.substring(3,fnm.length());
			}
			if(fnm.startsWith("das ")||fnm.startsWith("dos ")){
				fnm=fnm.substring(4,fnm.length());
			}
			if(fnm.endsWith(" de")||fnm.endsWith(" da")||fnm.endsWith(" do")){
				fnm=fnm.substring(0,fnm.length()-3);
			}
			if(fnm.endsWith(" das")||fnm.endsWith(" dos")){
				fnm=fnm.substring(0,fnm.length()-4);
			}
			fnm=fnm.replaceAll(" de ", " ");
			fnm=fnm.replaceAll(" do ", " ");
			fnm=fnm.replaceAll(" da ", " ");
			fnm=fnm.replaceAll(" das ", " ");
			fnm=fnm.replaceAll(" dos ", " ");
		}
//		System.out.println("FNM after:"+fnm);
...
//			System.out.println("runA::"+runA);
	...
	private String removeAbbreviation(String snm) throws IOException
	{	
		String surname = snm;
		if(XT.jid.equalsIgnoreCase("RPPED")||XT.jid.equalsIgnoreCase("RPPEDE")){
			//da”, “de”, “do”, “e” ‘van der’, ‘de la’, ‘von’,//Values exist in StyleSheet
			if(surname.startsWith("de ")||surname.startsWith("do ")||surname.startsWith("da ")){
				surname=surname.substring(3,surname.length());
			}
			if(surname.startsWith("e ")){
				surname=surname.substring(2,surname.length());
			}
			if(surname.startsWith("van der ")){
				surname=surname.substring(8,surname.length());
			}
			if(surname.startsWith("de la ")){
				surname=surname.substring(6,surname.length());
			}
			if(surname.startsWith("von ")){
				surname=surname.substring(4,surname.length());
			}
			
			if(surname.endsWith(" de")||surname.endsWith(" do")||surname.endsWith(" da")){
				surname=surname.substring(0,surname.length()-3);
			}
			if(surname.endsWith(" e")){
				surname=surname.substring(0,surname.length()-2);
			}
			if(surname.endsWith(" van der")){
				surname=surname.substring(0,surname.length()-8);
			}
			if(surname.endsWith(" de la")){
				surname=surname.substring(0,surname.length()-6);
			}
			if(surname.endsWith(" von")){
				surname=surname.substring(0,surname.length()-4);
			}
			
			surname=surname.replaceAll(" de ", " ");
			surname=surname.replaceAll(" do ", " ");
			surname=surname.replaceAll(" da ", " ");
			surname=surname.replaceAll(" e ", " ");
			surname=surname.replaceAll(" van der ", " ");
			surname=surname.replaceAll(" de la ", " ");
			surname=surname.replaceAll(" von ", " ");
		}
		return surname;
	}
...
//		abstractGraphical.append("\\documentclass[Stage=\"S100-GA\",Thumbnail,auto,onecolumn,Thumbnail,"+"Stage=\""+XT.stage+XT.web+"-draft\""+"]{XT-MOD"+modelStyle+"}\r\n");
	...
	if(!xmlObj.articleNo.isEmpty()){
		System.out.println("xmlObj.articleNo :1:> "+xmlObj.articleNo);
	...
	if((!xmlObj.jid.equalsIgnoreCase("APCATA")||!xmlObj.jid.equalsIgnoreCase("CPLETT")))
	{
		...
		if(!xmlObj.articleNo.isEmpty()){
			System.out.println("xmlObj.articleNo :2:> "+xmlObj.articleNo);
...
String line="";
	...
	public boolean isBrazilianAuthor(String jid, String aid)
	{
		Properties prop=new Properties();
		String ba=XT.databasePath+"\\BrazilianAuthor.dbf";
		if(new File(ba).exists()){
			prop=loadProp(ba);
			String propval=prop.getProperty(jid, "0");
			int cutOff;
			int itemAid;
			if(aid.indexOf(".",0)!=-1)
			{
			...
			try {
				cutOff = Integer.parseInt(propval);
				itemAid = Integer.parseInt(aid);
//				System.out.println("ItemAID="+itemAid+" and Cutoff="+cutOff);
				if(cutOff!=0 && itemAid >= cutOff){
//					System.out.println("BrazilianAuthor::true");
					return true;
				}
			} catch (NumberFormatException e) {
				System.out.println("CutOff no. in "+ba+" is in wrong format.");
				System.out.println("System is going to exit !!!");
				e.printStackTrace();
				System.exit(0);
			}
		}else{
			System.out.println(ba+" not exist. Please check");
			System.out.println("System is going to exit !!!");
			System.exit(0);
		}
//		System.out.println("BrazilianAuthor::false");
		return false;
	}
	
	public boolean ArticleNumberCutoff(String jid, String aid)
	{
		Properties prop=new Properties();
		String anList=XT.databasePath+"\\ArticleNumberJidList.dbf";
		if(new File(anList).exists()){
			prop=loadProp(anList);
			String propval=prop.getProperty(jid, "0");
			int cutOff;
			int itemAid;
			if(aid.indexOf(".",0)!=-1)
			...
			try {
				...
				System.out.println("ItemAID="+itemAid+" and Cutoff="+cutOff);
				if(cutOff!=0 && itemAid >= cutOff){
					if(XT.modelStyle.toUpperCase().startsWith("-MODDFRENCH") || XT.modelStyle.toUpperCase().startsWith("-MODEFRENCH") || XT.modelStyle.toUpperCase().contains("ENCEP") || XT.modelStyle.toUpperCase().contains("FRENCH") || XT.modelStyle.toUpperCase().contains("SPANISH")){
//						XT.isPPEworkflow(jid,aid)
						XT xtcls = new XT();
						try {
							if(xtcls.isPPEworkflow(jid, aid)){
								return true;
							}else{
								return false;
							}
						...
						System.out.println("Article-Number aid :: true");
						return true;
					}
				}else{
					System.out.println("Article-Number aid :: false");
				}
			} catch (NumberFormatException e) {
				System.out.println("CutOff no. in "+anList+" is in wrong format.");
				System.out.println("System is going to exit !!!");
				e.printStackTrace();
				System.exit(0);
			}
		}else{
			System.out.println(anList+" not exist. Please check");
			System.out.println("System is going to exit !!!");
			System.exit(0);
		}
	//	System.out.println("BrazilianAuthor::false");
...
//				System.exit(0);
	...
	public String intaid(String aid){
		String aidduckling=aid.toString();
		if(aidduckling.indexOf(".",0)!=-1)
		{
			aidduckling=aidduckling.substring(0,aidduckling.indexOf(".",0));
		}
		return aidduckling;
	}
	...
	//	stereoContents.append("\\documentclass[Stage=\"S100-GA\",Thumbnail,auto,onecolumn"+"Stage=\""+XT.stage+XT.web+"-draft\""+"]{XT-MOD"+modelStyle+XT.FMS+"}\r\n");//Commented by arvind [25-4-07]
		...
		if(!xmlObj.articleNo.isEmpty()){
			System.out.println("xmlObj.articleNo :3:> "+xmlObj.articleNo);
	...
	public boolean orcidJID(){
		boolean isOrcidJid = false;
		return isOrcidJid;
	}
	
	public boolean orcidJID(String jid, String aid){
		boolean isOrcidJid = false;
		String newsty="";
		Properties prop=new Properties();
		try {
			File cutoffDBF=new File(XT.databasePath+"\\OrcidJID.dbf");
			if(cutoffDBF.exists()){
				prop=loadProp(XT.databasePath+"\\OrcidJID.dbf");
				String orcidCutoff=prop.getProperty(jid,"0");
				if(orcidCutoff.equalsIgnoreCase("0")){
//					System.out.println("CutOff no. is not available in "+XT.databasePath+"/OrcidJID.dbf");
				}else{
					int cutOff = Integer.parseInt(orcidCutoff.trim());
					String temp_aid = aid;
					if(temp_aid.indexOf(".",0)!=-1)
					{
						temp_aid=temp_aid.substring(0,temp_aid.indexOf(".",0));
					}
					if(Integer.parseInt(temp_aid) >= cutOff){
						isOrcidJid = true;
					}
				}
			}
		} catch (NumberFormatException e) {
			System.out.println("CutOff no. in "+XT.databasePath+"/OrcidJID.dbf is in wrong format.");
			e.printStackTrace();
		} catch (Exception exp) {
			System.out.println("Exception in getting curoff from "+XT.databasePath+"/OrcidJID.dbf");
//			exp.printStackTrace();
		}
		return isOrcidJid;
	}
